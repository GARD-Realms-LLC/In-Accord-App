...
%c`, "color: #3a71c1; font-weight: 700;", "color: red; font-weight: 700;", "color: red;", error);
      ...
      static _log(module2, message, type = "log") {
        ...
        console[parsedType](`%c[In-Accord]%c [${module2}]%c`, "color: #3E82E5; font-weight: 700;", "color: #3a71c1;", "", ...message);
      }
...
var init_remote = __esm({
  "src/In-Accord/polyfill/remote.ts"() {
    "use strict";
    RemoteAPI = window.In - AccordPreload();
...
var init_fs = __esm({
  "src/In-Accord/polyfill/fs.ts"() {
    "use strict";
    init_remote();
    readFileSync = function(path11, options = "utf8") {
      return remote_default.filesystem.readFile(path11, options);
    };
    readFile = function(path11, options = "utf8", callback) {
      try {
        const contents = remote_default.filesystem.readFile(path11, options);
        callback(null, contents);
      } catch (error) {
        callback(error, null);
      }
    };
    writeFile = function(path11, data, options, callback) {
      if (typeof options === "function") {
        callback = options;
        if (!["object", "string"].includes(typeof options)) options = void 0;
      }
      try {
        remote_default.filesystem.writeFile(path11, data, options);
        callback?.(null);
      } catch (error) {
        callback?.(error);
      }
    };
    writeFileSync = function(path11, data, options) {
      remote_default.filesystem.writeFile(path11, data, options);
    };
    readdir = function(path11, options, callback) {
      try {
        const result = remote_default.filesystem.readDirectory(path11, options);
        callback(null, result);
      } catch (error) {
        callback(error, null);
      }
    };
    readdirSync = function(path11, options) {
      return remote_default.filesystem.readDirectory(path11, options);
    };
    mkdir = function(path11, options, callback) {
      try {
        const result = remote_default.filesystem.createDirectory(path11, options);
        callback(null, result);
      } catch (error) {
        callback(error, null);
      }
    };
    mkdirSync = function(path11, options) {
      remote_default.filesystem.createDirectory(path11, options);
    };
    rmdir = function(path11, options, callback) {
      try {
        const result = remote_default.filesystem.deleteDirectory(path11, options);
        callback(null, result);
      } catch (error) {
        callback(error, null);
      }
    };
    rmdirSync = function(path11, options) {
      remote_default.filesystem.deleteDirectory(path11, options);
    };
    rm = function(path11, callback) {
      try {
        const result = remote_default.filesystem.rm(path11);
        callback(null, result);
      } catch (error) {
        callback(error, null);
      }
    };
    rmSync = function(path11) {
      remote_default.filesystem.rmSync(path11);
    };
    exists = function(path11, callback) {
      try {
        const result = remote_default.filesystem.exists(path11);
        callback(null, result);
      } catch (error) {
        callback(error, null);
      }
    };
    existsSync = function(path11) {
      return remote_default.filesystem.exists(path11);
    };
    stat = function(path11, options, callback) {
      try {
        const result = remote_default.filesystem.getStats(path11, options);
        callback(null, result);
      } catch (error) {
        callback(error);
      }
    };
    statSync = function(path11, options) {
      return remote_default.filesystem.getStats(path11, options);
    };
    lstat = stat;
    lstatSync = statSync;
    ...
    realpath = function(path11, options, callback) {
      try {
        const result = remote_default.filesystem.getStats(path11, options);
        callback(null, result);
      } catch (error) {
    ...
    realpathSync = function(path11, options) {
      return remote_default.filesystem.getRealPath(path11, options);
    };
    watch = (path11, options, callback) => {
      return remote_default.filesystem.watch(path11, options, callback);
    };
    createWriteStream = (path11, options) => {
      return remote_default.filesystem.createWriteStream(path11, options);
    };
    unlinkSync = (path11) => remote_default.filesystem.unlinkSync(path11);
    unlink = (path11) => remote_default.filesystem.unlinkSync(path11);
    fs_default = {
      readFile,
      exists,
      existsSync,
...
var import_path, env, iaDataPath, backupFolderName, config_default;
var init_config = __esm({
  "src/In-Accord/stores/config.ts"() {
    ...
    init_base();
    env = process.env;
    iaDataPath = env.INACCORD_DATA_PATH ?? env.InAccord_DATA_PATH ?? env.inaccord_DATA_PATH ?? "";
    backupFolderName = env.inaccord_BACKUP_FOLDER ?? "backup";
...
var init_emitter = __esm({
  "src/In-Accord/modules/emitter.ts"() {
    ...
    emitter_default = new class BDEvents extends import_events3.default {
      constructor() {
        super();
    ...
    DefaultSettings = [
      ...
      },
      {
        ...
        settings: [
          ...
          // MacOS exclusive
          { type: "switch", id: "inAppTrafficLights", value: false, disabled: process.env.In - Accord_NATIVE_FRAME === "true", hidden: process.platform !== "darwin" }
        ]
      },
      {
        type: "category",
...
function getNestedProp(object, path11, skipLast) {
  if (!path11) return object;
  const split = path11.split(".");
...
function assign(filter, args) {
  return Object.assign(filter, {
    [/* @__PURE__ */ Symbol.for("In-Accord.Filter")]: args
  });
}
function byKeys(props, filter = (m) => m) {
  return assign((module2) => {
...
function combine(...filters) {
  return assign((exports, module2, id) => {
...
function not(filter) {
  return assign((exports, module2, id) => !filter(exports, module2, id), {
    filter
  });
}
...
function getDefaultKey(module2) {
  if ("A" in module2.exports) return "A";
  if ("Ay" in module2.exports) return "Ay";
...
var init_shared = __esm({
  "src/In-Accord/webpack/shared.ts"() {
    ...
    wrapFilter = (filter) => Object.assign(((exports, module2, moduleId) => {
      try {
...
// src/In-Accord/webpack/cache.ts
var import_path2, WebpackCache;
var init_cache = __esm({
  "src/In-Accord/webpack/cache.ts"() {
    ...
    WebpackCache = class {
      ...
      static load() {
        const filePath = import_path2.default.resolve(config_default.get("channelPath"), `webpack.json`);
        try {
...
function getMatched(module2, filter, options) {
...
function getModule(filter, options = {}) {
  ...
  if (options.firstId) {
    const module2 = webpackRequire.c[options.firstId];
    if (module2) {
      const matched = getMatched(module2, filter, options);
  ...
  for (let i = 0; i < keys2.length; i++) {
    const module2 = webpackRequire.c[keys2[i]];
    const matched = getMatched(module2, filter, options);
    if (matched) {
...
function mapObject(module2, mappers) {
  ...
  Object.defineProperty(mapped, /* @__PURE__ */ Symbol("In-Accord.getMangled"), {
    value: module2,
    configurable: false
  });
  return mapped;
...
function getMangled(filter, mappers, options = {}) {
  ...
  let module2 = typeof filter === "number" ? getById(filter, options) : getModule(filter, options);
  if (!module2) return {};
  if (options.raw) module2 = module2.exports;
  return mapObject(module2, mappers);
}
function bulkGetMatched(module2, options) {
...
function getBulk(...queries) {
  ...
  for (let i = 0; i < queries.length; i++) {
    ...
    if (!firstId) continue;
    const module2 = webpackRequire.c[firstId];
    if (!module2) continue;
    const matched = bulkGetMatched(module2, queries[i]);
  ...
  webpack: for (let i = 0; i < keys2.length; i++) {
    ...
    for (let index = 0; index < queries.length; index++) {
      ...
      const matched = bulkGetMatched(module2, queries[index]);
      if (!matched) continue;
      if (!all) {
...
var SyncModules, MemoModules, DiscordModules, discordmodules_default;
var init_discordmodules = __esm({
  "src/In-Accord/modules/discordmodules.ts"() {
    "use strict";
    init_utils();
    init_webpack2();
    SyncModules = getBulkKeyed({
      React: {
        filter: filter_exports.byKeys(["createElement", "cloneElement"]),
        firstId: 483362,
        cacheId: "core-React"
      },
      ReactSpring: {
        filter: filter_exports.byKeys(["useTransition", "animated"]),
        firstId: 429783,
        cacheId: "core-ReactSpring"
      },
      SimpleMarkdownWrapper: {
        filter: filter_exports.byKeys(["defaultRules", "parse"]),
        firstId: 454585,
        cacheId: "core-SimpleMarkdownWrapper"
      },
      Dispatcher: {
        filter: filter_exports.byKeys(["dispatch", "subscribe", "register"]),
        searchExports: true,
        firstId: 570140,
        cacheId: "core-Dispatcher"
      },
      Tooltip: {
        filter: filter_exports.byPrototypeKeys(["renderTooltip"]),
        searchExports: true,
        firstId: 481060,
      ...
      ChannelActions: {
        filter: filter_exports.byKeys(["selectPrivateChannel"]),
        firstId: 287734,
        cacheId: "core-ChannelActions"
      }
    });
    SyncModules.Tooltip ??= (props) => props.children?.({}) ?? null;
    MemoModules = memoizeObject({
      get InviteActions() {
        return getByKeys(["createInvite"], { firstId: 846293, cacheId: "core-InviteActions" });
      },
      get SimpleMarkdown() {
        return getByKeys(["parseBlock", "parseInline", "defaultOutput"], { firstId: 280230, cacheId: "core-SimpleMarkdown" });
      },
      get promptToUpload() {
        return getByStrings(["getUploadCount", ".UPLOAD_FILE_LIMIT_ERROR"], { searchExports: true, firstId: 518960, cacheId: "core-promptToUpload" });
      },
      get RemoteModule() {
        return getByKeys(["setBadge"], { firstId: 837921, cacheId: "core-RemoteModule" });
      },
      get UserAgentInfo() {
        return getByKeys(["os", "layout"], { firstId: 214958, cacheId: "core-UserAgentInfo" });
      },
      get GetClientInfo() {
        return getByStrings(["versionHash"], { firstId: 551602, cacheId: "core-GetClientInfo" });
      },
      get MessageUtils() {
        return getByKeys(["sendMessage"], { firstId: 843472, cacheId: "core-MessageUtils" });
      },
      get LinkParser() {
        return getModule((m) => m.html && m.requiredFirstCharacters?.[0] === "[", { firstId: 694403, cacheId: "core-LinkParser" });
      },
      get DiscordMarkdown() {
        return getModule((m) => m?.prototype?.render && m.rules, { firstId: 558179, cacheId: "core-DiscordMarkdown" });
      },
      get Layout() {
        return getBySource(["$Root", "buildLayout"], { searchDefault: false, firstId: 419954, cacheId: "core-Layout" });
      },
      get NoticesBaseClasses() {
        return getByKeys(["container", "base", "sidebar"], { cacheId: "core-NoticesBaseClasses" });
      },
      get NoticesPageClasses() {
        return getByKeys(["errorPage"], { cacheId: "core-NoticesPageClasses" });
      },
      get ViewClasses() {
        return getByKeys(["standardSidebarView"], { cacheId: "core-ViewClasses" });
      }
    });
    DiscordModules = Object.assign(MemoModules, SyncModules);
    discordmodules_default = DiscordModules;
  }
});

// src/In-Accord/modules/reactdom.ts
var base, client, ReactDOM, reactdom_default;
var init_reactdom = __esm({
  "src/In-Accord/modules/reactdom.ts"() {
    "use strict";
    init_webpack2();
    base = getByKeys(["createPortal", "render", "unmountComponentAtNode"], { searchExports: true, firstId: 340287, cacheId: "core-reactdom-base" });
    client = getByKeys(["createRoot", "hydrateRoot"], { searchExports: true, firstId: 507240, cacheId: "core-reactdom-client" });
    ReactDOM = Object.assign({}, base, client);
    if (typeof ReactDOM.createRoot !== "function" && typeof base?.render === "function") {
      ReactDOM.createRoot = (container) => ({
        render: (node) => base.render(node, container),
        unmount: () => typeof base.unmountComponentAtNode === "function" ? base.unmountComponentAtNode(container) : void 0
      });
    }
    reactdom_default = ReactDOM;
  }
});

// src/In-Accord/modules/react.ts
var React, react_default, ReactDOM2, Children, Component, Fragment, cloneElement, createContext, createElement, createRef, forwardRef, lazy, memo, startTransition, useCallback, useContext, useDebugValue, useDeferredValue, useEffect, useId, useImperativeHandle, useInsertionEffect, useLayoutEffect, useMemo, useReducer, useRef, useState, useSyncExternalStore, useTransition;
  ...
  "src/In-Accord/stores/json.ts"() {
    ...
    json_default = new class JsonStore extends Store {
      ...
      delete(file, key) {
        ...
        let data;
        try {
          data = JSON.parse(fs_default.readFileSync(import_path3.default.resolve(config_default.get("channelPath"), `${file}.json`)).toString());
        } catch {
          data = {};
        }
        return data;
      ...
      #save(file) {
        fs_default.writeFileSync(import_path3.default.resolve(config_default.get("channelPath"), `${file}.json`), JSON.stringify(this.cache[file], null, 4));
        this.emitChange();
      }
      // Plugin data
      #getPluginFile(pluginName) {
        return import_path3.default.resolve(config_default.get("pluginsPath"), pluginName + ".config.json");
      }
...
var init_circle_check = __esm({
  "node_modules/lucide-react/dist/esm/icons/circle-check.js"() {
    ...
    CircleCheck = createLucideIcon("circle-check", __iconNode8);
  }
});

// node_modules/lucide-react/dist/esm/icons/circle-dollar-sign.js
var __iconNode9, CircleDollarSign;
var init_circle_dollar_sign = __esm({
  "node_modules/lucide-react/dist/esm/icons/circle-dollar-sign.js"() {
    ...
    CircleDollarSign = createLucideIcon("circle-dollar-sign", __iconNode9);
  }
});

// node_modules/lucide-react/dist/esm/icons/circle-question-mark.js
var __iconNode10, CircleQuestionMark;
var init_circle_question_mark = __esm({
  "node_modules/lucide-react/dist/esm/icons/circle-question-mark.js"() {
    ...
    CircleQuestionMark = createLucideIcon("circle-question-mark", __iconNode10);
  }
});

// node_modules/lucide-react/dist/esm/icons/circle-x.js
var __iconNode11, CircleX;
var init_circle_x = __esm({
  "node_modules/lucide-react/dist/esm/icons/circle-x.js"() {
    ...
    CircleX = createLucideIcon("circle-x", __iconNode11);
  }
});
...
var init_eye = __esm({
  "node_modules/lucide-react/dist/esm/icons/eye.js"() {
    ...
    Eye = createLucideIcon("eye", __iconNode14);
  }
});

// node_modules/lucide-react/dist/esm/icons/folder.js
var __iconNode15, Folder;
var init_folder = __esm({
  "node_modules/lucide-react/dist/esm/icons/folder.js"() {
    ...
    Folder = createLucideIcon("folder", __iconNode15);
  }
});

// node_modules/lucide-react/dist/esm/icons/github.js
var __iconNode16, Github;
var init_github = __esm({
  "node_modules/lucide-react/dist/esm/icons/github.js"() {
    ...
    Github = createLucideIcon("github", __iconNode16);
  }
});

// node_modules/lucide-react/dist/esm/icons/globe.js
var __iconNode17, Globe;
var init_globe = __esm({
  "node_modules/lucide-react/dist/esm/icons/globe.js"() {
    ...
    Globe = createLucideIcon("globe", __iconNode17);
  }
});

// node_modules/lucide-react/dist/esm/icons/heart-handshake.js
var __iconNode18, HeartHandshake;
var init_heart_handshake = __esm({
  "node_modules/lucide-react/dist/esm/icons/heart-handshake.js"() {
    ...
    HeartHandshake = createLucideIcon("heart-handshake", __iconNode18);
  }
});

// node_modules/lucide-react/dist/esm/icons/history.js
var __iconNode19, History;
var init_history = __esm({
  "node_modules/lucide-react/dist/esm/icons/history.js"() {
    ...
    History = createLucideIcon("history", __iconNode19);
  }
});
...
var init_keyboard = __esm({
  "node_modules/lucide-react/dist/esm/icons/keyboard.js"() {
    ...
    Keyboard = createLucideIcon("keyboard", __iconNode21);
  }
});

// node_modules/lucide-react/dist/esm/icons/layout-grid.js
var __iconNode22, LayoutGrid;
var init_layout_grid = __esm({
  "node_modules/lucide-react/dist/esm/icons/layout-grid.js"() {
    ...
    LayoutGrid = createLucideIcon("layout-grid", __iconNode22);
  }
});

// node_modules/lucide-react/dist/esm/icons/list-restart.js
var __iconNode23, ListRestart;
var init_list_restart = __esm({
  "node_modules/lucide-react/dist/esm/icons/list-restart.js"() {
    ...
    ListRestart = createLucideIcon("list-restart", __iconNode23);
  }
});

// node_modules/lucide-react/dist/esm/icons/maximize.js
var __iconNode24, Maximize;
var init_maximize = __esm({
  "node_modules/lucide-react/dist/esm/icons/maximize.js"() {
    ...
    Maximize = createLucideIcon("maximize", __iconNode24);
  }
});
...
var init_package_open = __esm({
  "node_modules/lucide-react/dist/esm/icons/package-open.js"() {
    ...
    PackageOpen = createLucideIcon("package-open", __iconNode26);
  }
});

// node_modules/lucide-react/dist/esm/icons/palette.js
var __iconNode27, Palette;
var init_palette = __esm({
  "node_modules/lucide-react/dist/esm/icons/palette.js"() {
    ...
    Palette = createLucideIcon("palette", __iconNode27);
  }
});

// node_modules/lucide-react/dist/esm/icons/pencil.js
var __iconNode28, Pencil;
var init_pencil = __esm({
  "node_modules/lucide-react/dist/esm/icons/pencil.js"() {
    ...
    Pencil = createLucideIcon("pencil", __iconNode28);
  }
});

// node_modules/lucide-react/dist/esm/icons/pipette.js
var __iconNode29, Pipette;
var init_pipette = __esm({
  "node_modules/lucide-react/dist/esm/icons/pipette.js"() {
    ...
    Pipette = createLucideIcon("pipette", __iconNode29);
  }
});
...
var init_refresh_ccw = __esm({
  "node_modules/lucide-react/dist/esm/icons/refresh-ccw.js"() {
    ...
    RefreshCcw = createLucideIcon("refresh-ccw", __iconNode32);
  }
});

// node_modules/lucide-react/dist/esm/icons/refresh-cw.js
var __iconNode33, RefreshCw;
var init_refresh_cw = __esm({
  "node_modules/lucide-react/dist/esm/icons/refresh-cw.js"() {
    ...
    RefreshCw = createLucideIcon("refresh-cw", __iconNode33);
  }
});

// node_modules/lucide-react/dist/esm/icons/rotate-cw.js
var __iconNode34, RotateCw;
var init_rotate_cw = __esm({
  "node_modules/lucide-react/dist/esm/icons/rotate-cw.js"() {
    ...
    RotateCw = createLucideIcon("rotate-cw", __iconNode34);
  }
});

// node_modules/lucide-react/dist/esm/icons/save.js
var __iconNode35, Save;
var init_save = __esm({
  "node_modules/lucide-react/dist/esm/icons/save.js"() {
    init_createLucideIcon();
    __iconNode35 = [
    ...
    Save = createLucideIcon("save", __iconNode35);
  }
});

// node_modules/lucide-react/dist/esm/icons/search.js
var __iconNode36, Search;
var init_search = __esm({
  "node_modules/lucide-react/dist/esm/icons/search.js"() {
    ...
    Search = createLucideIcon("search", __iconNode36);
  }
});

// node_modules/lucide-react/dist/esm/icons/settings.js
var __iconNode37, Settings;
var init_settings2 = __esm({
  "node_modules/lucide-react/dist/esm/icons/settings.js"() {
    ...
    Settings = createLucideIcon("settings", __iconNode37);
  }
});

// node_modules/lucide-react/dist/esm/icons/shield-alert.js
var __iconNode38, ShieldAlert;
var init_shield_alert = __esm({
  "node_modules/lucide-react/dist/esm/icons/shield-alert.js"() {
    ...
    ShieldAlert = createLucideIcon("shield-alert", __iconNode38);
  }
});

// node_modules/lucide-react/dist/esm/icons/store.js
var __iconNode39, Store2;
var init_store = __esm({
  "node_modules/lucide-react/dist/esm/icons/store.js"() {
    ...
    Store2 = createLucideIcon("store", __iconNode39);
  }
});

// node_modules/lucide-react/dist/esm/icons/stretch-horizontal.js
var __iconNode40, StretchHorizontal;
var init_stretch_horizontal = __esm({
  "node_modules/lucide-react/dist/esm/icons/stretch-horizontal.js"() {
    ...
    StretchHorizontal = createLucideIcon("stretch-horizontal", __iconNode40);
  }
});

// node_modules/lucide-react/dist/esm/icons/tag.js
var __iconNode41, Tag;
var init_tag = __esm({
  "node_modules/lucide-react/dist/esm/icons/tag.js"() {
    init_createLucideIcon();
    __iconNode41 = [
    ...
    Tag = createLucideIcon("tag", __iconNode41);
  }
});
...
var __iconNode43, TriangleAlert;
var init_triangle_alert = __esm({
  "node_modules/lucide-react/dist/esm/icons/triangle-alert.js"() {
    ...
    TriangleAlert = createLucideIcon("triangle-alert", __iconNode43);
  }
});

// node_modules/lucide-react/dist/esm/icons/twitter.js
var __iconNode44, Twitter;
var init_twitter = __esm({
  "node_modules/lucide-react/dist/esm/icons/twitter.js"() {
    ...
    Twitter = createLucideIcon("twitter", __iconNode44);
  }
});
...
var init_x = __esm({
  "node_modules/lucide-react/dist/esm/icons/x.js"() {
    ...
    X = createLucideIcon("x", __iconNode46);
  }
});
...
var init_settings3 = __esm({
  "src/In-Accord/stores/settings.ts"() {
    ...
    settings_default2 = new class SettingsManager extends Store {
      ...
      getPath(path11, collectionId = "", categoryId = "") {
        const collection = path11.length == 3 ? path11[0] : collectionId;
        const category = path11.length == 3 ? path11[1] : path11.length == 2 ? path11[0] : categoryId;
        const setting = path11[path11.length - 1];
      ...
      setupCollection(id) {
        ...
        for (let cc = 0; cc < categories.length; cc++) {
          ...
          for (let s = 0; s < category.settings.length; s++) {
            ...
            const path11 = this.getPath(pathString.split("."), collection.id, category.id);
            Object.defineProperty(setting, "disabled", {
              enumerable: true,
              get: () => {
                const other = this.state[path11.collection][path11.category][path11.setting];
  ...
  "src/In-Accord/modules/patcher.ts"() {
    ...
    Patcher = class {
      ...
      static makeOverride(patch) {
        return function BDPatcher(...args) {
          let returnValue;
...
var init_ipcevents = __esm({
  "src/common/constants/ipcevents.ts"() {
    "use strict";
    MINIMIZE = "bd-window-minimize";
    MAXIMIZE = "bd-window-maximize";
    RELAUNCH = "bd-relaunch-app";
    RUN_SCRIPT = "bd-run-script";
    NAVIGATE = "bd-did-navigate-in-page";
    OPEN_DEVTOOLS = "bd-open-devtools";
    CLOSE_DEVTOOLS = "bd-close-devtools";
    TOGGLE_DEVTOOLS = "bd-toggle-devtools";
    OPEN_WINDOW = "bd-open-window";
    INSPECT_ELEMENT = "bd-inspect-element";
    MINIMUM_SIZE = "bd-minimum-size";
    WINDOW_SIZE = "bd-window-size";
    DEVTOOLS_WARNING = "bd-remove-devtools-message";
    OPEN_DIALOG = "bd-open-dialog";
    GET_ACCENT_COLOR = "bd-get-accent-color";
    OPEN_PATH = "bd-open-path";
  }
});
...
var init_ipc = __esm({
  "src/In-Accord/modules/ipc.ts"() {
    ...
    ipc_default = new class IPCRenderer {
      ...
      openPath(path11) {
        return import_electron.ipcRenderer.send(OPEN_PATH, path11);
      }
    }();
  }
});
    ...
    DOMManager = class {
      ...
      */
      ...
      static removeStyle(id) {
        id = this.escapeID(id);
        const exists2 = this.getElement(`#${id}`, this.bdStyles);
      ...
      static removeTheme(id) {
        id = this.escapeID(id);
        const exists2 = this.getElement(`#${id}`, this.bdThemes);
        if (exists2) exists2.remove();
      }
      ...
      static updateCustomCSS(css2) {
        this.bdCustomCSS.textContent = css2;
      }
      static removeScript(id) {
        id = this.escapeID(id);
        const exists2 = this.getElement(`#${id}`, this.bdScripts);
        if (exists2) exists2.remove();
      }
...
function Button({
  ...
  return /* @__PURE__ */ react_default.createElement(
    ...
    /* @__PURE__ */ react_default.createElement("div", { className: "bd-button-content" }, children)
  );
}
...
function Child(props) {
  ...
  props.className = clsx_default(props.className, "bd-flex-child");
...
var init_divider = __esm({
  "src/In-Accord/ui/divider.tsx"() {
    ...
    init_react();
    init_clsx();
    divider_default = ({ className, ...props }) => /* @__PURE__ */ react_default.createElement("hr", { ...props, className: clsx_default("bd-divider", className) });
  }
});
...
function Header({ id, className, children, justify }) {
  return /* @__PURE__ */ react_default.createElement(
    ...
    {
      id,
      className: clsx_default("bd-modal-header", className),
      grow: 0,
      shrink: 0,
...
function Content({ id, className, children, scroller = true }) {
  return /* @__PURE__ */ react_default.createElement("div", { id, className: clsx_default("bd-modal-content", { "bd-scroller-base bd-scroller-thin": scroller }, className) }, children);
}
...
function ModalRoot({ className, transitionState, children, size = Sizes3.DYNAMIC, style = Styles.CUSTOM }) {
  ...
  const preferences = react_default.useContext(discordmodules_default.AccessibilityContext ?? {});
  const reducedMotion = preferences?.reducedMotion?.enabled ?? document.documentElement?.classList.contains("reduce-motion");
  const springStyles = discordmodules_default.ReactSpring.useSpring({
    opacity: visible ? 1 : 0,
  ...
  return /* @__PURE__ */ react_default.createElement(FocusLock, { disableTrack: true }, /* @__PURE__ */ react_default.createElement(
    discordmodules_default.ReactSpring.animated.div,
    {
      className: clsx_default("bd-modal-root", size, className, style),
      style: springStyles
    },
    children
  ));
}
var Anims, Sizes3, Styles, FocusLock;
var init_root = __esm({
  "src/In-Accord/ui/modals/root.tsx"() {
    "use strict";
    init_clsx();
    ...
    init_discordmodules();
    init_webpack2();
    Anims = getByKeys(["Easing"], { firstId: 615300, cacheId: "core-modalroot-anims" });
    ...
    FocusLock = getModule((m) => m?.render?.toString().includes("impressionProperties") && m?.render?.toString().includes(".Provider"), {
      searchExports: true,
      firstId: 305866,
...
function Footer({ id, className, children, justify, direction, align, wrap }) {
  return /* @__PURE__ */ react_default.createElement(
    ...
    {
      id,
      className: clsx_default("bd-modal-footer", className),
      grow: 0,
      shrink: 0,
...
function AddonError2({ err, index }) {
  ...
  function renderErrorBody() {
    ...
    return /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-error-body" }, /* @__PURE__ */ react_default.createElement(divider_default, null), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-error-stack" }, Parser ? Parser.codeBlock.react?.({ content: stack, lang: "js" }, null, {}) : stack));
  }
  return /* @__PURE__ */ react_default.createElement("details", { key: `${err.type}-${index}`, className: clsx_default("bd-addon-error", expanded ? "expanded" : "collapsed") }, /* @__PURE__ */ react_default.createElement("summary", { className: "bd-addon-error-header", onClick: toggle }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-error-icon" }, err.type == "plugin" ? /* @__PURE__ */ react_default.createElement(Plug, null) : /* @__PURE__ */ react_default.createElement(Palette, null)), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-error-header-inner" }, /* @__PURE__ */ react_default.createElement(Text, { tag: "h3", size: Text.Sizes.SIZE_16, color: Text.Colors.HEADER_PRIMARY, strong: true }, err.name), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-error-details" }, /* @__PURE__ */ react_default.createElement(Info, { className: "bd-addon-error-details-icon", size: "16px" }), /* @__PURE__ */ react_default.createElement(Text, { color: Text.Colors.HEADER_SECONDARY, size: Text.Sizes.SIZE_12 }, err.message))), /* @__PURE__ */ react_default.createElement(ChevronRight, { className: "bd-addon-error-expander", size: "24px" })), renderErrorBody());
}
function generateTab(id, errors) {
  return { id, errors, name: t(`Panels.${id}`) };
}
function AddonErrorModal({ transitionState, onClose, pluginErrors, themeErrors }) {
  const tabs = useMemo2(() => {
    return [
  ...
  return /* @__PURE__ */ react_default.createElement(ModalRoot, { transitionState, className: "bd-error-modal", size: ModalRoot.Sizes.MEDIUM }, /* @__PURE__ */ react_default.createElement(Header, { className: "bd-error-modal-header" }, /* @__PURE__ */ react_default.createElement(Flex, { direction: Flex.Direction.VERTICAL }, /* @__PURE__ */ react_default.createElement(Text, { tag: "h1", size: Text.Sizes.SIZE_14, color: Text.Colors.HEADER_PRIMARY, strong: true, style: { textTransform: "uppercase", marginBottom: "8px" } }, t("Modals.addonErrors")), /* @__PURE__ */ react_default.createElement("div", { className: "bd-tab-bar" }, tabs.map((tab) => /* @__PURE__ */ react_default.createElement("div", { onClick: () => {
    switchToTab(tab.id);
  }, className: clsx_default("bd-tab-item", tab.id === selectedTab.id && "selected") }, tab.name))))), /* @__PURE__ */ react_default.createElement(Content, { className: "bd-error-modal-content" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-errors" }, selectedTab.errors.map((error, index) => /* @__PURE__ */ react_default.createElement(AddonError2, { index, err: error })))), /* @__PURE__ */ react_default.createElement(Footer, { className: "bd-error-modal-footer" }, /* @__PURE__ */ react_default.createElement(Button, { onClick: onClose }, t("Modals.okay"))));
}
...
var init_addonerrormodal = __esm({
  "src/In-Accord/ui/modals/addonerrormodal.tsx"() {
    ...
    init_clsx();
    init_discordmodules();
    Parser = discordmodules_default.SimpleMarkdownWrapper.defaultRules;
...
var init_errorboundary = __esm({
  "src/In-Accord/ui/errorboundary.tsx"() {
    ...
    ErrorBoundary = class extends react_default.Component {
      ...
      render() {
        if (this.state.hasError && this.props.fallback) {
          ...
          return /* @__PURE__ */ react_default.createElement("div", { onClick: () => ipc_default.openDevTools(), className: "react-error" }, "There was an unexpected Error. Click to open console for more details.");
        }
    ...
    Object.defineProperty(ErrorBoundary.prototype, "render", {
      ...
      configurable: false,
      set: function() {
        Logger.warn("ErrorBoundary", "Addon policy for plugins https://docs.In-Accord.app/plugins/publishing/guidelines#scope");
      },
      get: () => originalRender
    });
  }
...
function setupMarkdown() {
  DiscordMarkdown = discordmodules_default.DiscordMarkdown;
  rules = {};
  if (DiscordMarkdown) {
    rules = {
...
function Markdown({ className, children }) {
  ...
  if (!DiscordMarkdown) return /* @__PURE__ */ react_default.createElement("div", { className: "bd-markdown-fallback" }, children);
  return /* @__PURE__ */ react_default.createElement(
    DiscordMarkdown,
    {
      className: className ?? "",
...
function Video({ src, poster }) {
  ...
  return /* @__PURE__ */ react_default.createElement("video", { src, poster, controls: true, className: "bd-changelog-poster" });
}
function ChangelogModal({ transitionState, footer, title, subtitle, onClose, video, poster, banner, blurb, changes }) {
  ...
  const changelogItems = useMemo3(() => {
    ...
    else if (banner) items.push(/* @__PURE__ */ react_default.createElement("img", { src: banner, className: "bd-changelog-poster" }));
    ...
    for (let c = 0; c < (changes?.length ?? 0); c++) {
      ...
      items.push(/* @__PURE__ */ react_default.createElement("h1", { className: `bd-changelog-title ${type}${margin}` }, entry.title));
  ...
  return /* @__PURE__ */ react_default.createElement(ModalRoot, { className: "bd-changelog-modal", transitionState, size: ModalRoot.Sizes.MEDIUM, style: ModalRoot.Styles.STANDARD }, ChangelogHeader, /* @__PURE__ */ react_default.createElement(Content, null, changelogItems), (footer || title === "In-Accord") && ChangelogFooter);
}
...
var init_changelog = __esm({
  "src/In-Accord/ui/modals/changelog.tsx"() {
    ...
    AnchorClasses = getByKeys(["anchorUnderlineOnHover"], {
      firstId: 820162,
    ...
    twitter = /* @__PURE__ */ react_default.createElement(discordmodules_default.Tooltip, { color: "primary", position: "top", text: t("Socials.twitter") }, (p) => /* @__PURE__ */ react_default.createElement("a", { ...p, className: "bd-social", href: "https://x.com/_In-Accord_", rel: "noopener noreferrer", target: "_blank" }, /* @__PURE__ */ react_default.createElement(Twitter, { size: "18px" })));
    github = /* @__PURE__ */ react_default.createElement(discordmodules_default.Tooltip, { color: "primary", position: "top", text: t("Socials.github") }, (p) => /* @__PURE__ */ react_default.createElement("a", { ...p, className: "bd-social", href: "https://github.com/In-Accord/In-Accord", rel: "noopener noreferrer", target: "_blank" }, /* @__PURE__ */ react_default.createElement(Github, { size: "18px" })));
  }
});
...
function Backdrop({ isVisible, className, onClick }) {
  ...
  return transition((styles2, visible) => {
    ...
    return /* @__PURE__ */ react_default.createElement(
      Spring.animated.div,
      {
        className: clsx_default("bd-modal-backdrop", className),
        style: styles2,
        onClick
      }
    );
...
var init_stack = __esm({
  "src/In-Accord/ui/modals/stack.tsx"() {
    ...
    ModalLayer = class extends react_default.Component {
      ...
      render() {
        return react_default.createElement("div", { className: "bd-modal-layer" }, this.props.render({
    ...
    Modals = class {
      ...
      static get ModalActions() {
        return this._ModalActions ??= getMangled("?.stackNextByDefault", {
          openModal: filter_exports.byStrings("?.stackNextByDefault"),
          closeModal: filter_exports.byStrings(".setState", ".getState()["),
          closeAllModals: filter_exports.byStrings(".getState();for")
        }, {
          firstId: 192308,
          cacheId: "In-Accord-modals"
        });
      }
      static default(title, content, buttons = []) {
        ...
        if (Array.isArray(content) ? content.every((el) => react_default.isValidElement(el)) : react_default.isValidElement(content)) {
          ...
          const root = reactdom_default.createRoot(container);
          try {
            root.render(content);
          } catch (error) {
      ...
      static async showGuildJoinModal(code) {
        ...
        const minimize = Patcher.instead("In-Accord~showGuildJoinModal", discordmodules_default.RemoteModule, "minimize", () => {
        });
        const focus = Patcher.instead("In-Accord~showGuildJoinModal", discordmodules_default.RemoteModule, "focus", () => {
        });
        try {
...
var init_editor = __esm({
  "src/In-Accord/stores/editor.ts"() {
    ...
    init_settings3();
    init_remote();
    EDITOR_URL_REGEX = /^In-Accord:\/\/editor\/(?:custom-css|(theme|plugin)\/([^/]+))\/?/;
        ...
        remote_default.addProtocolListener((url) => {
          ...
          if (match[1] === void 0) {
            ...
            const manager = (
              ...
              (match[1] === "theme" ? (init_thememanager(), __toCommonJS(thememanager_exports)) : (init_pluginmanager(), __toCommonJS(pluginmanager_exports))).default
            );
    ...
    editor_default2 = new class Editor {
      ...
      async loadMonaco() {
        ...
        try {
          ...
          amdLoader(["vs/editor/browser/controller/textAreaInput"], ({ TextAreaWrapper }) => {
...
var init_contexts = __esm({
  "src/In-Accord/ui/contexts.ts"() {
    "use strict";
    init_react();
    none = /* @__PURE__ */ Symbol("In-Accord.none");
...
function Switch({ id = void 0, value: initialValue, disabled = void 0, onChange, internalState = true }) {
  ...
  return /* @__PURE__ */ react_default.createElement("div", { className: `bd-switch` + enabledClass + checkedClass }, /* @__PURE__ */ react_default.createElement("input", { id, type: "checkbox", disabled: isDisabled, checked: isChecked, onChange: change }), /* @__PURE__ */ react_default.createElement("div", { className: "bd-switch-body" }, /* @__PURE__ */ react_default.createElement("svg", { className: "bd-switch-slider", viewBox: "0 0 28 20", preserveAspectRatio: "xMinYMid meet" }, /* @__PURE__ */ react_default.createElement("rect", { className: "bd-switch-handle", fill: "white", x: "4", y: "0", height: "20", width: "20", rx: "10" }), /* @__PURE__ */ react_default.createElement("svg", { className: "bd-switch-symbol", viewBox: "0 0 20 20", fill: "none" }, /* @__PURE__ */ react_default.createElement("path", null), /* @__PURE__ */ react_default.createElement("path", null)))));
}
...
var init_editor3 = __esm({
  "src/In-Accord/ui/customcss/editor.tsx"() {
    ...
    editor_default3 = forwardRef2(function CodeEditor({ value, language: requestedLang = "css", id = "bd-editor", controls = [], onChange: notifyParent }, editorRef) {
      ...
      useLayoutEffect(() => {
        ...
        if (editor_default2.failedToLoad) {
          createFallback();
          return;
        }
        let disposed = false;
      ...
      return /* @__PURE__ */ react_default.createElement("div", { id: "bd-editor-panel", className: theme, ref: windowRef }, /* @__PURE__ */ react_default.createElement("div", { id: "bd-editor-controls" }, /* @__PURE__ */ react_default.createElement("div", { className: "controls-section controls-left" }, controlsLeft), /* @__PURE__ */ react_default.createElement("div", { className: "controls-section controls-right" }, controlsRight)), /* @__PURE__ */ react_default.createElement("div", { className: "editor-wrapper" }, /* @__PURE__ */ react_default.createElement("div", { id, ref, className: "editor " + theme }), showingProblems && /* @__PURE__ */ react_default.createElement("div", { className: "bd-editor-problems" }, markerInfo[2].length === 0 && /* @__PURE__ */ react_default.createElement("div", { className: "bd-editor-no-problems" }, "No Problems have been detected."), markerInfo[2].map((marker, index) => /* @__PURE__ */ react_default.createElement("div", { key: index, className: `bd-editor-problem bd-editor-severity-${marker.severity}` }, marker.severity === 8 ? (
      ...
      ) : /* @__PURE__ */ react_default.createElement(Info, { size: "1em" }), /* @__PURE__ */ react_default.createElement("span", null, marker.message), /* @__PURE__ */ react_default.createElement("span", null, marker.source, "(", marker.code, ")"), /* @__PURE__ */ react_default.createElement("span", null, "[Ln ", marker.startLineNumber, ", Col ", marker.startColumn, "]"))))), !editor?.isFallback && /* @__PURE__ */ react_default.createElement("div", { className: "bd-editor-footer" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-editor-footer-left" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-editor-footer-item", onClick: toggleShowingProblems }, /* @__PURE__ */ react_default.createElement(CircleX, { size: "1em" }), /* @__PURE__ */ react_default.createElement("span", null, " ", markerInfo[0], " "), /* @__PURE__ */ react_default.createElement(TriangleAlert, { size: "1em" }), /* @__PURE__ */ react_default.createElement("span", null, " ", markerInfo[1]))), /* @__PURE__ */ react_default.createElement("div", { className: "bd-editor-footer-right" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-editor-footer-item", onClick: gotoLine }, /* @__PURE__ */ react_default.createElement("span", null, "Ln ", selection[0]), /* @__PURE__ */ react_default.createElement("span", null, ", "), /* @__PURE__ */ react_default.createElement("span", null, "Col ", selection[1]), !!selection[2] && /* @__PURE__ */ react_default.createElement("span", null, " (", selection[2], " selected)")), /* @__PURE__ */ react_default.createElement("div", { className: "bd-editor-footer-item" }, /* @__PURE__ */ react_default.createElement("span", null, insertSpaces ? "Spaces" : "Tabs"), /* @__PURE__ */ react_default.createElement("span", null, ": "), /* @__PURE__ */ react_default.createElement("span", null, tabSize)), /* @__PURE__ */ react_default.createElement("div", { className: "bd-editor-footer-item" }, /* @__PURE__ */ react_default.createElement(Braces, { size: "1em" }), /* @__PURE__ */ react_default.createElement("span", null, " ", language)))));
    });
  }
});
...
var init_addoneditor = __esm({
  "src/In-Accord/ui/misc/addoneditor.tsx"() {
    ...
    addoneditor_default = forwardRef3(function AddonEditor({ content, language, save, openNative, id = "bd-addon-editor" }, ref) {
...
function FloatingWindowContainer() {
...
var init_floatingwindows = __esm({
  "src/In-Accord/ui/floatingwindows.tsx"() {
    ...
    FloatingWindows = class {
      static initialize() {
        const container = /* @__PURE__ */ react_default.createElement(FloatingWindowContainer, null);
        const wrapped = AppLayerProvider ? react_default.createElement(AppLayerProvider().props.layerContext.Provider, { value: [document.querySelector("#app-mount > .layerContainer-2v_Sit")] }, container) : container;
...
var import_path4, import_fs5, openItem, splitRegex, escapedAtRegex, stripBOM, AddonManager;
  ...
  "src/In-Accord/modules/addonmanager.ts"() {
    ...
    AddonManager = class extends Store {
      ...
      watchAddons() {
        ...
        this.watcher = import_fs5.default.watch(this.addonFolder, { persistent: false }, async (eventType, filename) => {
          if (!eventType || !filename) return;
          const absolutePath = import_path4.default.resolve(this.addonFolder, filename);
          if (!filename.endsWith(this.extension)) {
            ...
            if (import_fs5.default.existsSync(newFilename)) {
              Logger.warn(this.name, `Duplicate files found: ${filename} and ${newFilename}`);
              return;
            }
            try {
              import_fs5.default.renameSync(absolutePath, import_path4.default.resolve(this.addonFolder, newFilename));
            } catch (error) {
          ...
          try {
            const stats = import_fs5.default.statSync(absolutePath);
      ...
      requireAddon(filename) {
        let fileContent = import_fs5.default.readFileSync(filename, "utf8");
        fileContent = stripBOM(fileContent);
        const stats = import_fs5.default.statSync(filename);
        const addon = this.extractMeta(fileContent, import_path4.default.basename(filename));
        ...
        addon.id = addon.name || import_path4.default.basename(filename);
        addon.slug = import_path4.default.basename(filename).replace(this.extension, "").replace(/ /g, "-");
        addon.filename = import_path4.default.basename(filename);
      ...
      loadAddon(filename, shouldToast = false) {
        ...
        let addon;
        try {
          addon = this.requireAddon(import_path4.default.resolve(this.addonFolder, filename));
        } catch (e) {
      ...
      loadNewAddons() {
        const files = import_fs5.default.readdirSync(this.addonFolder);
        const removed = this.addonList.filter((a) => !files.includes(a.filename)).map((c) => c.id);
        const added = files.filter((f) => !this.addonList.find((a) => a.filename == f) && f.endsWith(this.extension) && import_fs5.default.statSync(import_path4.default.resolve(this.addonFolder, f)).isFile());
      ...
      deleteAddon(idOrFileOrAddon) {
        const addon = typeof idOrFileOrAddon == "string" ? this.addonList.find((c) => c.id == idOrFileOrAddon || c.filename == idOrFileOrAddon) : idOrFileOrAddon;
        if (!addon) return;
        return import_fs5.default.unlinkSync(import_path4.default.resolve(this.addonFolder, addon.filename));
      }
      saveAddon(idOrFileOrAddon, content) {
        const addon = typeof idOrFileOrAddon == "string" ? this.addonList.find((c) => c.id == idOrFileOrAddon || c.filename == idOrFileOrAddon) : idOrFileOrAddon;
        if (!addon) return;
        return import_fs5.default.writeFileSync(import_path4.default.resolve(this.addonFolder, addon.filename), content);
      }
      editAddon(idOrFileOrAddon, system) {
        const addon = typeof idOrFileOrAddon == "string" ? this.addonList.find((c) => c.id == idOrFileOrAddon || c.filename == idOrFileOrAddon) : idOrFileOrAddon;
        if (!addon) return;
        const fullPath = import_path4.default.resolve(this.addonFolder, addon.filename);
      ...
      openDetached(addon) {
        const fullPath = import_path4.default.resolve(this.addonFolder, addon.filename);
        const content = import_fs5.default.readFileSync(fullPath).toString();
...
var import_path5, import_vm3, normalizeExports, pluginmanager_default;
    ...
    pluginmanager_default = new class PluginManager extends AddonManager {
      ...
      requireAddon(filename) {
        ...
        try {
          ...
          import_vm3.default.compileFunction(addon.fileContent, ["require", "module", "exports", "__filename", "__dirname"], { filename: import_path5.default.basename(filename) });
          addon.fileContent += normalizeExports(addon.exports || addon.name);
          addon.fileContent += `
//# sourceURL=In-Accord://plugins/${addon.filename}`;
...
var deprecated = /* @__PURE__ */ new Map([
  ["request", "Use Ia-Api.Net.fetch instead."],
  ["https", "Use Ia-Api.Net.fetch instead."]
]);
var originalFs = Object.assign({}, fs_default);
originalFs.writeFileSync = (path11, data, options) => fs_default.writeFileSync(path11, data, Object.assign({}, options, { originalFs: true }));
originalFs.writeFile = (path11, data, options) => fs_default.writeFile(path11, data, Object.assign({}, options, { originalFs: true }));
var createRequire = function(path11) {
  return (mod) => {
    ...
    switch (mod) {
      ...
      default:
        return Module._load(mod, path11, createRequire);
    }
  };
};
var require2 = window.require = createRequire(".");
require2.cache = {};
require2.resolve = (path11) => {
  for (const key of Object.keys(require2.cache)) {
    if (key.startsWith(path11)) return require2.cache[key];
  }
};
...
loadingIcon.title = "In-Accord is loading...";
  ...
  changes: [
    {
      ...
      type: "fixed",
      items: [
        "In-Accord now loads on macOS and Linux."
      ]
    },
    {
      title: "New Features",
...
__export(builtins_exports, {
  ...
  BDContextMenu: () => contextmenu_default2,
...
var iconClasses = {
  ...getModule((x) => x.wrapper && x.icon && x.selected && x.selectable && !x.mask, { firstId: 60090, cacheId: "core-commandmanager-iconClasses" }),
  builtInSeparator: getModule((x) => x.builtInSeparator, { firstId: 681755, cacheId: "core-commandmanager-builtInSeparatorClasses" })?.builtInSeparator
};
...
var CommandManager = class _CommandManager {
  ...
  static User = getByStrings(["hasHadPremium(){"], { firstId: 427157, cacheId: "core-commandmanager-user" });
  static createBotMessage = getByStrings(['username:"Clyde"'], { searchExports: true, firstId: 963852, cacheId: "core-commandmanager-createBotMessage" });
  static MessagesModule = getByKeys(["receiveMessage"], { firstId: 843472, cacheId: "core-commandmanager-messages" });
  static IconsModule = getByKeys(["BOT_AVATARS"], { firstId: 820883, cacheId: "core-commandmanager-icons" });
  static localBDBot;
  static initialize() {
  ...
  static #patchCommandSystem() {
    ...
    this.IconsModule.BOT_AVATARS["In-Accord"] = "https://github.com/In-Accord.png";
  }
  static #patchSidebarModule() {
    const SidebarModule = getByStrings([".BUILT_IN?", "categoryListRef:"], { defaultExport: false });
    Patcher.after("CommandManager", SidebarModule, "A", (_, [props], res) => {
  ...
  static #patchIndexStore() {
    const [mod, key] = getWithKey(filter_exports.byStrings(".getScoreWithoutLoadingLatest"), { firstId: 264322, cacheId: "core-commandmanager-indexstore" });
  ...
  static #patchApplicationIcons() {
    ...
    Patcher.after("CommandManager", mod, key, (_, [{ id }], res) => {
      const getIconUrl = () => {
        const metadataIcon = pluginmanager_default.getAddon(id)?.icon || pluginmanager_default.getPlugin(id)?.instance?.icon || null;
  ...
  static #ensureSection(caller) {
    if (!this.#sections.has(caller)) {
      this.#sections.set(caller, {
        ...
        type: 1,
        key: "1",
        icon: caller === "In-Accord" ? "https://github.com/In-Accord.png" : null,
        isBD: true
      });
    }
  }
...
var BuiltinModule = class {
  ...
  addCommands(...commands) {
    for (const command of commands) {
      const unregister = commandmanager_default.registerCommand("In-Accord", command);
...
// src/In-Accord/modules/nodepatcher.ts
init_react();
var NodePatcher = class {
  #id = /* @__PURE__ */ Symbol("In-Accord.NodePatcher");
  #cache = /* @__PURE__ */ new WeakMap();
  #destroyed = false;
  patch(node, callback) {
    ...
    if (type.prototype?.isReactComponent) {
      ...
      ComponentType[this.#id] = ComponentType;
      node.type = ComponentType;
      return;
    }
    const FC = reactutils_default.getType(type);
    function FunctionType(...args) {
      ...
      if (res instanceof Promise) {
        return res.then((awaited) => {
          ...
          const ret2 = callback(props, awaited);
          if (typeof ret2 === "undefined") return awaited;
          return ret2;
        });
      }
      if (isDestroyed()) return res;
      const ret = callback(props, res);
      if (typeof ret === "undefined") return res;
      return ret;
    }
    let newType = FunctionType;
    if (typeof type === "object") {
      const t2 = type;
      if (t2.type) {
        newType = react_default.memo(t2.type?.render ? react_default.forwardRef(newType) : newType, t2.compare);
      } else if (t2.render) {
        newType = react_default.forwardRef(newType);
      } else if (t2._payload) {
        newType = react_default.lazy(() => {
          const out = t2._init(t2._payload);
...
var localemanager_default = new class LocaleManager {
  get discordLocale() {
    return Stores.LocaleStore?.locale ?? this.defaultLocale;
  }
  get defaultLocale() {
    return "en-US";
  }
  initialize() {
    ...
    Stores.LocaleStore?.addChangeListener(() => i18n_default.setLocale(this.discordLocale));
  }
}();
...
var HOSTNAME = "In-Accord.app";
var API_VERSION = "v3";
var join = (...paths) => {
  const path11 = paths.map(($path) => $path.match(/\/*(.+)\/*/)?.[1]).filter(Boolean).join("/");
  return `https://${HOSTNAME}/${path11}`;
};
var apiJoin = (...paths) => {
  const path11 = paths.map(($path) => $path.match(/\/*(.+)\/*/)?.[1]).filter(Boolean).join("/");
  return `https://api.${HOSTNAME}/${API_VERSION}/${path11}`;
};
...
var Web = class _Web {
   ...
   * @example
   * https://raw.githubusercontent.com/QWERTxD/In-AccordPlugins/298752533fbbdab511c3a3f4ffe6afd41d0a93f1/CallTimeCounter/CallTimeCounter.plugin.js
   * https://github.com/QWERTxD/In-AccordPlugins/blob/298752533fbbdab511c3a3f4ffe6afd41d0a93f1/CallTimeCounter/CallTimeCounter.plugin.js
   * @param {string} rawGitURL
   */
  ...
  static resources = {
    ...
    thumbnail: (thumbnail) => join(thumbnail || _Web.resources.EMPTY_THUMBNAIL)
  };
  static store = {
...
function CheckBox(props) {
  ...
  return /* @__PURE__ */ react_default.createElement(
    Flex,
    {
      className: clsx_default("bd-checkbox", props.className, { "bd-checkbox-disabled": props.disabled, "bd-checkbox-has-label": props.label, "bd-checkbox-reverse": props.reverse }),
      align: Flex.Align.CENTER,
    ...
    /* @__PURE__ */ react_default.createElement(
      "input",
      {
        ...
        checked: state,
        id: props.id,
        className: clsx_default("bd-checkbox-input", props.inputClassName)
      }
    ),
    /* @__PURE__ */ react_default.createElement("div", { className: clsx_default("bd-checkbox-box", props.iconClassName) }, /* @__PURE__ */ react_default.createElement(Check, { size: "18px" })),
    props.label && /* @__PURE__ */ react_default.createElement("div", { className: clsx_default("bd-checkbox-label", props.label) }, props.label)
  );
}
...
init_react();
init_discordmodules();
var AccessibilityContext = discordmodules_default.AccessibilityContext || react_default.createContext({
...
function Spinner(props) {
  const { reducedMotion } = react_default.useContext(AccessibilityContext);
  ...
  const itemClassName = react_default.useMemo(() => {
    return clsx_default("bd-spinner-path", props.itemClassName);
  }, [props.itemClassName]);
  switch (type) {
    ...
    case SpinnerType.SPINNING_CIRCLE_SIMPLE: {
      return /* @__PURE__ */ react_default.createElement(
        ...
        /* @__PURE__ */ react_default.createElement("div", { className: "bd-spinner-inner" }, /* @__PURE__ */ react_default.createElement(
          "svg",
          {
    ...
    default: {
      return /* @__PURE__ */ react_default.createElement(
        ...
        /* @__PURE__ */ react_default.createElement("span", { className: "bd-spinner-inner" }, /* @__PURE__ */ react_default.createElement("span", { className: itemClassName }), /* @__PURE__ */ react_default.createElement("span", { className: itemClassName }), (type === SpinnerType.PULSING_ELLIPSIS || type === SpinnerType.LOW_MOTION) && /* @__PURE__ */ react_default.createElement("span", { className: itemClassName }))
      );
    }
  }
}
...
var basicClass = "bd-settings-title";
var groupClass = "bd-settings-title bd-settings-group-title";
function SettingsTitle({ isGroup = false, className = "", button = void 0, onClick = void 0, text, children = [] }) {
  ...
  return /* @__PURE__ */ react_default.createElement("h2", { className: titleClass, onClick: () => {
    onClick?.();
  } }, text, button && /* @__PURE__ */ react_default.createElement(Button, { className: "bd-button-title", onClick: click, size: Button.Sizes.NONE }, button.title), children);
}
...
function makeBasicButton(title, children, action, key) {
  return /* @__PURE__ */ react_default.createElement(discordmodules_default.Tooltip, { color: "primary", position: "top", "aria-label": title, text: title, key }, (props) => /* @__PURE__ */ react_default.createElement(Button, { ...props, "aria-label": title, size: Button.Sizes.NONE, look: Button.Looks.BLANK, className: "bd-button", onClick: action }, children));
}
...
function AddonHeader({ children, count, searching }) {
  ...
  return set(
    /* @__PURE__ */ react_default.createElement(
      SettingsTitle,
      {
        text: /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-title", "data-showing-store": showingStore }, /* @__PURE__ */ react_default.createElement("span", { onClick: exitStore }, title), showingStore && /* @__PURE__ */ react_default.createElement(react_default.Fragment, null, /* @__PURE__ */ react_default.createElement(ChevronRight, { size: "24px" }), /* @__PURE__ */ react_default.createElement("span", null, t("Addons.store"))), searching && /* @__PURE__ */ react_default.createElement("span", null, " - ", t("Addons.results", { count })))
      },
      children
    )
  );
...
function FlowerStar({ size = 16 }) {
  return /* @__PURE__ */ react_default.createElement(discordmodules_default.Tooltip, { text: t("Addons.official"), "aria-label": t("Addons.official"), hideOnClick: false }, (props) => /* @__PURE__ */ react_default.createElement("div", { className: "bd-flower-star", ...props }, /* @__PURE__ */ react_default.createElement(BadgeCheck, { size: `${size}px` })));
}
...
function ModalItem({ leading, content, trailing, action }) {
  return /* @__PURE__ */ react_default.createElement(Flex, { onClick: action, className: `bd-install-modal-item${typeof action === "function" ? " bd-install-modal-clickable" : ""}`, align: Flex.Align.CENTER }, leading && /* @__PURE__ */ react_default.createElement("div", { className: "bd-install-modal-item-leading" }, leading), content && /* @__PURE__ */ react_default.createElement("div", { className: "bd-install-modal-item-content" }, content), trailing && /* @__PURE__ */ react_default.createElement("div", { className: "bd-install-modal-item-trailing" }, trailing));
}
function GuildIcon({ guild }) {
  ...
  return /* @__PURE__ */ react_default.createElement("div", { className: "bd-install-modal-guild", ref }, state === 0 ? /* @__PURE__ */ react_default.createElement(spinner_default, { type: spinner_default.Type.PULSING_ELLIPSIS }) : state === 1 ? null : guild.acronym);
}
function InstallModal({ addon, transitionState, install, onClose }) {
  ...
  return /* @__PURE__ */ react_default.createElement(ModalRoot, { transitionState, size: ModalRoot.Sizes.SMALL, className: "bd-addon-store-modal" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-install-modal-splash" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-install-modal-preview" }, /* @__PURE__ */ react_default.createElement(
    "img",
    {
      src: addon.thumbnail,
      onError: (event) => {
  ...
  )), /* @__PURE__ */ react_default.createElement("div", { className: "bd-install-modal-author" }, /* @__PURE__ */ react_default.createElement(
    "svg",
    {
      height: 48,
      width: 48,
    ...
    /* @__PURE__ */ react_default.createElement(
      ...
      /* @__PURE__ */ react_default.createElement("div", { className: "bd-install-modal-author-mask" }, /* @__PURE__ */ react_default.createElement(
        "svg",
        {
          height: 40,
          width: 40,
  ...
  ))), /* @__PURE__ */ react_default.createElement("div", { className: "bd-install-modal-header" }, /* @__PURE__ */ react_default.createElement(FlowerStar, { size: 20 }), /* @__PURE__ */ react_default.createElement(Text, { size: Text.Sizes.SIZE_20, color: Text.Colors.HEADER_PRIMARY }, addon.name)), /* @__PURE__ */ react_default.createElement("div", { className: "bd-install-modal-items" }, /* @__PURE__ */ react_default.createElement(
    ModalItem,
    {
    ...
    ModalItem,
    {
      ...
      trailing: /* @__PURE__ */ react_default.createElement(GuildIcon, { guild: addon.guild }),
    ...
    const install = (shouldEnable) => new Promise((resolve, reject) => {
      request(Web.redirects.github(this.id.toString()), {
        ...
        try {
          ...
          import_fs6.default.writeFileSync(import_path6.default.join(this.manager.addonFolder, this.filename), text);
          ...
          toasts_default.show(t("Addons.failedToDownload", { context: this.type, name: this.name }), {
            type: "error"
          });
          reject(error);
        } finally {
    ...
    return this._singleAddonCache[idOrName] ??= new Promise((resolve, reject) => {
      request(Web.store.addon(idOrName), {
        ...
        try {
          ...
          toasts_default.show(t("Addons.failedToFetch"), {
            type: "error"
          });
...
function AddonCard({ addon, isEmbed }) {
  ...
  return /* @__PURE__ */ react_default.createElement(
    ...
    /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-splash" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-preview" }, /* @__PURE__ */ react_default.createElement(
      "img",
      {
        src: addon.thumbnail,
        onError: (event) => {
    ...
    )), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-author" }, /* @__PURE__ */ react_default.createElement(
      "svg",
      {
        height: 48,
        width: 48,
      ...
      /* @__PURE__ */ react_default.createElement(
        ...
        /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-author-mask" }, /* @__PURE__ */ react_default.createElement(
          "svg",
          {
            height: 40,
            width: 40,
    ...
    )), badge && /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-badge" }, badge)),
    /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-body" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-name" }, /* @__PURE__ */ react_default.createElement(FlowerStar, null), /* @__PURE__ */ react_default.createElement("span", null, addon.name)), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-description" }, addon.description), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-tags" }, addon.tags.map((tag) => /* @__PURE__ */ react_default.createElement(
      "span",
      {
        className: clsx_default({ "bd-addon-store-card-tag": true, "bd-addon-store-card-tag-selected": isTagEnabled(tag) }),
        onClick: () => toggleTag(tag)
      },
      tag
    ))), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-spacer" }), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-info" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-likes" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-dot" }), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-value" }, likes)), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-downloads" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-dot" }), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-value" }, downloads))), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-actions" }, /* @__PURE__ */ react_default.createElement(discordmodules_default.Tooltip, { text: t("Addons.website") }, (props) => /* @__PURE__ */ react_default.createElement(
      Button,
      {
        ...props,
        size: Button.Sizes.ICON,
    ...
    )), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-spacer" }), isInstalled ? /* @__PURE__ */ react_default.createElement(discordmodules_default.Tooltip, { text: t("Addons.deleteAddon") }, (props) => /* @__PURE__ */ react_default.createElement(
      Button,
      {
        ...props,
...
function Search2({ onChange, className, onKeyDown, placeholder }) {
  ...
  return /* @__PURE__ */ react_default.createElement("div", { className: "bd-search-wrapper" + (className ? ` ${className}` : "") }, /* @__PURE__ */ react_default.createElement("input", { onChange: change, onKeyDown, type: "text", className: "bd-search", placeholder, maxLength: 50, value, ref: input }), !value && /* @__PURE__ */ react_default.createElement(Search, { size: "18px" }), value && /* @__PURE__ */ react_default.createElement(Button, { look: Button.Looks.BLANK, color: Button.Colors.TRANSPARENT, size: Button.Sizes.NONE, onClick: reset }, /* @__PURE__ */ react_default.createElement(X, { size: "16px" })));
}
...
init_clsx();
init_lucide_react();
var { useState: useState12, useCallback: useCallback14, useContext: useContext3, useEffect: useEffect9, useLayoutEffect: useLayoutEffect4, useRef: useRef7 } = react_default;
function Select({ value: initialValue, options, style, onChange, disabled }) {
  ...
  return /* @__PURE__ */ react_default.createElement(react_default.Fragment, null, /* @__PURE__ */ react_default.createElement(
    "button",
    {
      ref: selectRef,
      type: "button",
      className: clsx_default("bd-select", isDisabled && "bd-select-disabled", style == "transparent" && "bd-select-transparent"),
      disabled: isDisabled
    },
    /* @__PURE__ */ react_default.createElement("span", { className: "bd-select-value" }, selected.label),
    /* @__PURE__ */ react_default.createElement(ChevronDown, { size: "16px", className: "bd-select-arrow" })
  ), /* @__PURE__ */ react_default.createElement(
    "ul",
    {
      ref: optionsRef,
    ...
    options.map(
      (opt) => /* @__PURE__ */ react_default.createElement(
        "li",
        {
          ref: selected.value == opt.value ? selectedRef : null,
          className: clsx_default("bd-select-option", selected.value == opt.value && "selected"),
          role: "option",
...
function NoResults(props) {
  return /* @__PURE__ */ react_default.createElement("div", { className: clsx_default("bd-empty-results", props.className) }, props.image ? props.image : /* @__PURE__ */ react_default.createElement(MagnifyingGlass, null), /* @__PURE__ */ react_default.createElement("div", { className: "bd-empty-results-text" }, props.text || t("Addons.results", { count: 0 }) || ""), props.children);
}
...
function Paginator({ className, currentPage, length, pageSize, onPageChange, maxVisible = 7 }) {
  ...
  return /* @__PURE__ */ react_default.createElement("div", { className: clsx_default("bd-paginator", className) }, /* @__PURE__ */ react_default.createElement(
    Button,
    {
    ...
    t("Paginator.back")
  ), /* @__PURE__ */ react_default.createElement("div", { className: "bd-paginator-bubbles" }, visiblePages.map((value, key) => {
...
function StoreContent({ content, refToScroller, page, setPage }) {
  ...
  return /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-wrapper" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store" }, cards), /* @__PURE__ */ react_default.createElement(
    Paginator,
    {
      currentPage: page,
...
function TagDropdown({ type, selected, onChange }) {
  const selectRef = react_default.useRef(null);
  const optionsRef = react_default.useRef(null);
  ...
  return /* @__PURE__ */ react_default.createElement(react_default.Fragment, null, /* @__PURE__ */ react_default.createElement(
    ...
    /* @__PURE__ */ react_default.createElement("span", { className: "bd-select-value" }, selectedTags.length, "/", tags.length),
    /* @__PURE__ */ react_default.createElement(ChevronDown, { className: "bd-select-arrow", size: "16px" })
  ), /* @__PURE__ */ react_default.createElement(
    "ul",
    {
      ref: optionsRef,
    ...
    tags.map((tag, index) => {
      ...
      return /* @__PURE__ */ react_default.createElement(
        ...
        /* @__PURE__ */ react_default.createElement("input", { type: "checkbox", checked: isSelected, readOnly: true }),
        tag
      );
    })
  ));
...
function AddonStorePage({ type, refToScroller }) {
  ...
  const content = useMemo7(() => {
    if (loading) {
      return /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-center" }, /* @__PURE__ */ react_default.createElement(spinner_default, { type: spinner_default.Type.WANDERING_CUBES }));
    }
    if (!filtered.length) {
      return /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-center" }, /* @__PURE__ */ react_default.createElement(NoResults, null));
    }
  ...
  return [
    ...
    /* @__PURE__ */ react_default.createElement("div", { className: "bd-controls bd-addon-controls" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-controls-basic" }, makeBasicButton(t("Addons.openFolder", { context: type }), /* @__PURE__ */ react_default.createElement(Folder, { size: "20px" }), () => ipc_default.openPath(manager.addonFolder), "folder"), makeBasicButton(t("Addons.reload"), /* @__PURE__ */ react_default.createElement(RotateCw, { size: "20px" }), () => loading ? {} : addonstore_default.requestAddons(), "reload")), /* @__PURE__ */ react_default.createElement("div", { className: "bd-controls-advanced" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-dropdowns" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-select-wrapper" }, /* @__PURE__ */ react_default.createElement("label", { className: "bd-label" }, t("Addons.tags"), ":"), /* @__PURE__ */ react_default.createElement(
      TagDropdown,
      {
        type,
        selected: tags,
    ...
    )), /* @__PURE__ */ react_default.createElement("div", { className: "bd-select-wrapper" }, /* @__PURE__ */ react_default.createElement("label", { className: "bd-label" }, t("Sorting.sortBy"), ":"), /* @__PURE__ */ react_default.createElement(Select, { options: buildSortOptions(), value: sort, onChange: changeSort, style: "transparent" })), /* @__PURE__ */ react_default.createElement("div", { className: "bd-select-wrapper" }, /* @__PURE__ */ react_default.createElement("label", { className: "bd-label" }, t("Sorting.order"), ":"), /* @__PURE__ */ react_default.createElement(Select, { options: buildDirectionOptions(), value: ascending, onChange: changeDirection, style: "transparent" }))))),
    !loading && error && /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-warning" }, /* @__PURE__ */ react_default.createElement(Info, { size: "24px" }), /* @__PURE__ */ react_default.createElement("div", null, /* @__PURE__ */ react_default.createElement("div", null, t("Addons.failedToFetch")), /* @__PURE__ */ react_default.createElement("div", null, error.message))),
    /* @__PURE__ */ react_default.createElement(
      TagContext.Provider,
      {
        value: [
...
var UserStore = getByKeys(["getCurrentUser"], { firstId: 287809, cacheId: "core-addoncard-UserStore" });
var ChannelStore = getByKeys(["getDMFromUserId"], { firstId: 734057, cacheId: "core-addoncard-ChannelStore" });
...
function makeButton2(title, children, action, { isControl = false, danger = false, disabled = false } = {}) {
  ...
  return /* @__PURE__ */ react_default.createElement(discordmodules_default.Tooltip, { color: "primary", position: "top", text: title }, (props) => {
    return /* @__PURE__ */ react_default.createElement(ButtonType, { ...props, "aria-label": title.toString(), className: (isControl ? "bd-button bd-button-filled bd-addon-button" : "bd-addon-button") + (danger ? " bd-button-color-red" : isControl ? " bd-button-color-brand" : "") + (disabled ? " bd-button-disabled" : ""), onClick: action, disabled }, children);
  });
}
function buildLink(type, url) {
  if (!url) return null;
  const icon = react_default.createElement(LinkIcons[type], { size: "20px" });
  const link = /* @__PURE__ */ react_default.createElement("a", { className: "bd-link bd-link-website", href: url, target: "_blank", rel: "noopener noreferrer" }, icon);
  if (type == "invite") {
...
function AddonCard2({ addon, enabled, type, disabled, onChange: parentChange, hasSettings, editAddon, deleteAddon, getSettingsPanel }) {
  ...
  const title = useMemo8(() => {
    ...
    const authorComponent = addon.authorLink || addon.authorId ? /* @__PURE__ */ react_default.createElement("a", { className: "bd-link bd-link-website", href: addon.authorLink || "", onClick: messageAuthor, target: "_blank", rel: "noopener noreferrer" }, getString(addon.author)) : /* @__PURE__ */ react_default.createElement("span", { className: "bd-author" }, getString(addon.author));
    const authorIndex = authorArray.findIndex((s) => s == "{{author}}");
    if (authorIndex) authorArray[authorIndex] = authorComponent;
    return [
      /* @__PURE__ */ react_default.createElement("div", { className: "bd-name" }, getString(addon.name)),
      /* @__PURE__ */ react_default.createElement("div", { className: "bd-meta" }, /* @__PURE__ */ react_default.createElement("span", { className: "bd-version" }, "v", getString(addon.version)), authorArray)
    ];
  ...
  const footer = useMemo8(() => {
    ...
    return /* @__PURE__ */ react_default.createElement("div", { className: "bd-footer" }, /* @__PURE__ */ react_default.createElement("span", { className: "bd-links" }, linkComponents), /* @__PURE__ */ react_default.createElement("div", { className: "bd-controls" }, hasSettings && makeButton2(t("Addons.addonSettings"), /* @__PURE__ */ react_default.createElement(Settings, { size: "20px" }), showSettings, { isControl: true, disabled: !enabled }), editAddon && makeButton2(t("Addons.editAddon"), /* @__PURE__ */ react_default.createElement(Pencil, { size: "20px" }), editAddon, { isControl: true }), deleteAddon && makeButton2(t("Addons.deleteAddon"), /* @__PURE__ */ react_default.createElement(Trash2, { size: "20px" }), deleteAddon, { isControl: true, danger: true })));
  }, [hasSettings, editAddon, deleteAddon, addon, enabled, showSettings]);
  return /* @__PURE__ */ react_default.createElement("div", { id: `${addon.id}-card`, className: "bd-addon-card" + (disabled ? " bd-addon-card-disabled" : "") }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-header" }, type === "plugin" ? /* @__PURE__ */ react_default.createElement(Plug, { size: "20px", className: "bd-icon" }) : /* @__PURE__ */ react_default.createElement(Palette, { size: "20px", className: "bd-icon" }), /* @__PURE__ */ react_default.createElement("div", { className: "bd-title" }, title), /* @__PURE__ */ react_default.createElement(Switch, { internalState: false, disabled, value: enabled, onChange })), /* @__PURE__ */ react_default.createElement("div", { className: "bd-description-wrap" }, disabled && /* @__PURE__ */ react_default.createElement("div", { className: "banner banner-danger" }, /* @__PURE__ */ react_default.createElement(ShieldAlert, { className: "bd-icon" }), `An error was encountered while trying to load this ${type}.`), /* @__PURE__ */ react_default.createElement("div", { className: "bd-description" }, SimpleMarkdownExt.parseToReact(getString(addon.description)))), footer);
}
...
function Empty(props) {
  return /* @__PURE__ */ react_default.createElement("div", { className: clsx_default("bd-empty-image-container", props.className) }, /* @__PURE__ */ react_default.createElement(EmptyImage, null), /* @__PURE__ */ react_default.createElement("div", { className: "bd-empty-image-title" }, props.title || t("Addons.blankSlateHeaderGeneric")), /* @__PURE__ */ react_default.createElement("div", { className: "bd-empty-image-message" }, SimpleMarkdownExt.parseToReact(props.message || t("Addons.blankSlateMessageGeneric"))), props.children);
}
...
function Blankslate({ type, folder }) {
  ...
  const storeEnabled = settings_default2.get("settings", "store", "bdAddonStore");
...
function makeControlButton(title, children, action, selected = false) {
  return /* @__PURE__ */ react_default.createElement(discordmodules_default.Tooltip, { color: "primary", position: "top", text: title.toString() }, (props) => {
    return /* @__PURE__ */ react_default.createElement(Button, { ...props, size: Button.Sizes.NONE, "aria-label": title.toString(), look: Button.Looks.BLANK, className: "bd-button bd-view-button" + (selected ? " selected" : ""), onClick: action }, children);
  });
}
...
function StoreCard() {
  ...
  if (!settings_default2.get("settings", "store", "bdAddonStore")) return;
  return /* @__PURE__ */ react_default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ react_default.createElement("div", { className: "bd-store-card-icon" }, /* @__PURE__ */ react_default.createElement(Store2, { size: "24px" })),
    /* @__PURE__ */ react_default.createElement("div", { className: "bd-store-card-body" }, /* @__PURE__ */ react_default.createElement(Text, { color: Text.Colors.HEADER_PRIMARY, className: "bd-store-card-title" }, t("Addons.openStore", { context: store.prefix })), /* @__PURE__ */ react_default.createElement(Text, { color: Text.Colors.HEADER_SECONDARY, className: "bd-store-card-description" }, t("Addons.storeMessage", { context: store.prefix }))),
    /* @__PURE__ */ react_default.createElement("div", { className: "bd-store-card-caret" }, /* @__PURE__ */ react_default.createElement(ChevronRight, { size: "24px" }))
  );
}
function AddonList({ store }) {
  ...
  return [
    ...
    /* @__PURE__ */ react_default.createElement("div", { className: "bd-controls bd-addon-controls" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-controls-basic" }, makeBasicButton(t("Addons.openFolder", { context: store.prefix }), /* @__PURE__ */ react_default.createElement(Folder, { size: "20px" }), openFolder.bind(null, store.addonFolder), "folder"), makeBasicButton(t("Addons.enableAll"), /* @__PURE__ */ react_default.createElement(Check, { size: "20px" }), confirmEnable(enableAll, store.prefix), "enable-all"), makeBasicButton(t("Addons.disableAll"), /* @__PURE__ */ react_default.createElement(X, { size: "20px" }), disableAll, "disable-all")), /* @__PURE__ */ react_default.createElement("div", { className: "bd-controls-advanced" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-dropdowns" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-select-wrapper" }, /* @__PURE__ */ react_default.createElement("label", { className: "bd-label" }, t("Sorting.sortBy"), ":"), /* @__PURE__ */ react_default.createElement(Select, { options: buildSortOptions2(), value: sort, onChange: changeSort, style: "transparent" })), /* @__PURE__ */ react_default.createElement("div", { className: "bd-select-wrapper" }, /* @__PURE__ */ react_default.createElement("label", { className: "bd-label" }, t("Sorting.order"), ":"), /* @__PURE__ */ react_default.createElement(Select, { options: buildDirectionOptions(), value: ascending, onChange: changeDirection, style: "transparent" }))), /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-views" }, makeControlButton(t("Addons.listView"), /* @__PURE__ */ react_default.createElement(StretchHorizontal, { size: "20px" }), listView, view === "list"), makeControlButton(t("Addons.gridView"), /* @__PURE__ */ react_default.createElement(LayoutGrid, null), gridView, view === "grid")))),
    ...
    hasAddonsInstalled && /* @__PURE__ */ react_default.createElement("div", { key: "addonList", className: "bd-addon-list" + (view == "grid" ? " bd-grid-view" : "") }, renderedCards)
  ];
}
...
function AddonPage(props) {
  const [showStore, setShowStore] = useState14(() => settings_default2.get("settings", "store", "bdAddonStore") && !props.store.addonList.length);
...
function SettingsTitle2() {
  return /* @__PURE__ */ react_default.createElement("div", { className: "bd-sidebar-header" }, /* @__PURE__ */ react_default.createElement("h2", { className: "bd-sidebar-header-label" }, "In-Accord"), /* @__PURE__ */ react_default.createElement(discordmodules_default.Tooltip, { color: "primary", position: "top", "aria-label": t("Modals.changelog"), text: t("Modals.changelog") }, (props) => /* @__PURE__ */ react_default.createElement(Button, { ...props, "aria-label": t("Modals.changelog"), className: "bd-changelog-button", look: Button.Looks.BLANK, color: Button.Colors.TRANSPARENT, size: Button.Sizes.NONE, onClick: () => Modals.showChangelogModal(changelog_default) }, /* @__PURE__ */ react_default.createElement(History, { className: "bd-icon", size: "16px" }))));
}
...
function VersionInfo() {
  ...
  const currentUser = useMemo9(() => Stores.UserStore?.getCurrentUser()?.id, []);
...
\`\`\``);
  ...
  return /* @__PURE__ */ react_default.createElement(discordmodules_default.Tooltip, { color, position: "top", text: tooltip }, (props) => /* @__PURE__ */ react_default.createElement("div", { ...props, className: "bd-version-info", onClick, onMouseLeave: (e) => {
    props.onMouseLeave(e);
    onMouseLeave();
  } }, discordInfo, /* @__PURE__ */ react_default.createElement(Text, { color: Text.Colors.MUTED, size: Text.Sizes.SIZE_12 }, "BD ", getCoreInfo()), /* @__PURE__ */ react_default.createElement(Text, { color: Text.Colors.MUTED, size: Text.Sizes.SIZE_12 }, t("Panels.plugins"), " ", pluginCount.total, " (", pluginCount.enabled, " ", t("Addons.isEnabled"), ")"), /* @__PURE__ */ react_default.createElement(Text, { color: Text.Colors.MUTED, size: Text.Sizes.SIZE_12 }, t("Panels.themes"), " ", themeCount.total, " (", themeCount.enabled, " ", t("Addons.isEnabled"), ")")));
}
...
init_react();
init_divider();
var { useState: useState16, useCallback: useCallback19, useRef: useRef8 } = react_default;
var baseClassName = "bd-settings-group";
function Drawer({ name, collapsible, shown = true, showDivider, children, titleChildren, onDrawerToggle }) {
  ...
  return /* @__PURE__ */ react_default.createElement("div", { className: groupClass2 }, /* @__PURE__ */ react_default.createElement(SettingsTitle, { text: name, onClick: toggleCollapse, isGroup: true }, titleChildren), /* @__PURE__ */ react_default.createElement("div", { className: "bd-settings-container", ref: container }, children), showDivider && /* @__PURE__ */ react_default.createElement(divider_default, null));
}
...
function Number2({ value: initialValue, min, max, step = 1, onChange, disabled }) {
  ...
  return /* @__PURE__ */ react_default.createElement("div", { className: `bd-number-input-wrapper ${isDisabled ? "bd-number-input-disabled" : ""}` }, /* @__PURE__ */ react_default.createElement(Button, { size: Button.Sizes.ICON, look: Button.Looks.FILLED, color: Button.Colors.PRIMARY, className: "bd-number-input-decrement", onClick: decrement }, /* @__PURE__ */ react_default.createElement(Minus, { size: "24px" })), /* @__PURE__ */ react_default.createElement("input", { onChange: change, type: "number", className: "bd-number-input", min, max, step, value, disabled: isDisabled }), /* @__PURE__ */ react_default.createElement(Button, { size: Button.Sizes.ICON, look: Button.Looks.FILLED, color: Button.Colors.PRIMARY, className: "bd-number-input-increment", onClick: increment }, /* @__PURE__ */ react_default.createElement(Plus, { size: "24px" })));
}
...
function SettingItem({ id, name, note, inline, children }) {
  return /* @__PURE__ */ react_default.createElement("div", { className: "bd-setting-item" + (inline ? " inline" : "") }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-setting-header" }, /* @__PURE__ */ react_default.createElement("label", { htmlFor: id, className: "bd-setting-title" }, name), inline && children), /* @__PURE__ */ react_default.createElement("div", { className: "bd-setting-note" }, note), !inline && children, /* @__PURE__ */ react_default.createElement(divider_default, { className: "bd-setting-divider" }));
}
...
function Textbox({ value: initialValue, maxLength, placeholder, onKeyDown, onChange, disabled }) {
  ...
  return /* @__PURE__ */ react_default.createElement("input", { onChange: change, onKeyDown, type: "text", className: "bd-text-input", placeholder, maxLength, value, disabled: isDisabled });
}

// src/In-Accord/ui/settings/components/slider.tsx
init_react();
init_contexts();
var { useState: useState19, useCallback: useCallback22, useMemo: useMemo10, useRef: useRef9, useContext: useContext6 } = react_default;
function Slider({ value: initialValue, min, max, step, onChange, disabled, units = "", markers = [] }) {
  ...
  return /* @__PURE__ */ react_default.createElement("div", { className: `bd-slider-wrap ${isDisabled ? "bd-slider-disabled" : ""} ${markers.length > 0 ? "bd-slider-markers" : ""}` }, /* @__PURE__ */ react_default.createElement("input", { onChange: change, type: "range", className: "bd-slider-input", min, max, step, value, disabled, ref: inputRef }), /* @__PURE__ */ react_default.createElement("div", { className: "bd-slider-label", style: { left: `${percent(value)}%`, transform: `translateX(${labelOffset}%)` } }, value, units), /* @__PURE__ */ react_default.createElement("div", { className: "bd-slider-track", style: { backgroundSize: percent(value) + "% 100%" }, onClick: trackClick }), markers?.length > 0 && /* @__PURE__ */ react_default.createElement("div", { className: "bd-slider-marker-container" }, markers.map((m) => {
    ...
    return /* @__PURE__ */ react_default.createElement("div", { className: "bd-slider-marker", style: { left: percent(markerValue) + "%" }, onClick: () => jumpToValue(markerValue) }, markerLabel, showUnits && units);
  })));
}
...
function RadioIndicator({ checked }) {
  return /* @__PURE__ */ react_default.createElement("svg", { className: "bd-radio-indicator", width: "24", height: "24", viewBox: "0 0 24 24" }, /* @__PURE__ */ react_default.createElement(
    "circle",
    {
      cx: "12",
      cy: "12",
...
function Radio({ name, value: initialValue, options, onChange, disabled }) {
  ...
  function renderOption(opt, i) {
    ...
    return /* @__PURE__ */ react_default.createElement("label", { className: "bd-radio-option" + (isSelected ? " bd-radio-selected" : ""), style: { borderColor: opt.color ?? "transparent" } }, /* @__PURE__ */ react_default.createElement("input", { onChange: change, type: "radio", name, checked: isSelected, value: i, disabled: isDisabled }), /* @__PURE__ */ react_default.createElement(RadioIndicator, { checked: isSelected }), /* @__PURE__ */ react_default.createElement("div", { className: "bd-radio-label-wrap" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-radio-label" }, opt.name), /* @__PURE__ */ react_default.createElement("div", { className: "bd-radio-description" }, opt.desc || opt.description)));
  }
  return /* @__PURE__ */ react_default.createElement("div", { className: `bd-radio-group ${isDisabled ? "bd-radio-disabled" : ""}` }, options.map(renderOption));
}
...
init_lucide_react();
init_contexts();
var { useState: useState21, useCallback: useCallback24, useEffect: useEffect10, useContext: useContext8 } = react_default;
function Keybind({ value: initialValue, onChange, max = 4, clearable = false, disabled }) {
  ...
  return /* @__PURE__ */ react_default.createElement("div", { className: "bd-keybind-wrap" + (state.isRecording ? " recording" : "") + (isDisabled ? " bd-keybind-disabled" : ""), onClick }, /* @__PURE__ */ react_default.createElement(Button, { size: Button.Sizes.ICON, look: Button.Looks.FILLED, color: state.isRecording ? Button.Colors.RED : Button.Colors.PRIMARY, className: "bd-keybind-record", onClick }, /* @__PURE__ */ react_default.createElement(Keyboard, { size: "24px" })), /* @__PURE__ */ react_default.createElement("input", { readOnly: true, type: "text", className: "bd-keybind-input", value: displayValue, placeholder: "No keybind set", disabled }), clearable && /* @__PURE__ */ react_default.createElement(Button, { size: Button.Sizes.ICON, look: Button.Looks.BLANK, onClick: clearKeybind, className: "bd-keybind-clear" }, /* @__PURE__ */ react_default.createElement(X, { size: "24px" })));
}
...
function Color({ value: initialValue, onChange, colors = defaultColors, defaultValue, disabled }) {
  ...
  return /* @__PURE__ */ react_default.createElement("div", { className: `bd-color-picker-container ${isDisabled ? "bd-color-picker-disabled" : ""}` }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-color-picker-controls" }, defaultValue && /* @__PURE__ */ react_default.createElement(discordmodules_default.Tooltip, { text: "Default", position: "bottom" }, (props) => /* @__PURE__ */ react_default.createElement("div", { ...props, className: "bd-color-picker-default", style: { backgroundColor: resolveColor(defaultValue) }, onClick: () => change({ target: { value: defaultValue } }) }, intValue === resolveColor(defaultValue, false) ? /* @__PURE__ */ react_default.createElement(Check, { size: "25px", color: getContrastColor(resolveColor(defaultValue, true)) }) : null)), /* @__PURE__ */ react_default.createElement(discordmodules_default.Tooltip, { text: t("Settings.customColor"), position: "bottom" }, (props) => /* @__PURE__ */ react_default.createElement("div", { className: "bd-color-picker-custom" }, /* @__PURE__ */ react_default.createElement(Pipette, { size: "14px", color: getContrastColor(resolveColor(value, true)) }), /* @__PURE__ */ react_default.createElement("input", { ...props, style: { backgroundColor: resolveColor(value) }, type: "color", className: "bd-color-picker", value: resolveColor(value), onChange: change, disabled })))), colors?.length > 0 && /* @__PURE__ */ react_default.createElement("div", { className: "bd-color-picker-swatch" }, colors.map((int, index) => /* @__PURE__ */ react_default.createElement("div", { key: index, className: "bd-color-picker-swatch-item", style: { backgroundColor: resolveColor(int) }, onClick: () => change({ target: { value: int } }) }, intValue === int ? /* @__PURE__ */ react_default.createElement(Check, { size: "16px", color: getContrastColor(resolveColor(value, true)) }) : null))));
}
...
init_button();
init_lucide_react();
var { useRef: useRef10, useCallback: useCallback26, useEffect: useEffect11 } = react_default;
function Filepicker({ multiple, accept, clearable, onChange, disabled, actions }) {
  ...
  return /* @__PURE__ */ react_default.createElement("div", { className: `bd-file-input-wrap ${disabled ? "bd-file-input-disabled" : ""}` }, /* @__PURE__ */ react_default.createElement(Button, { size: Button.Sizes.ICON, look: Button.Looks.FILLED, color: Button.Colors.PRIMARY, className: "bd-file-input-browse", onClick }, "Browse"), /* @__PURE__ */ react_default.createElement("input", { onChange: change, type: "file", className: "bd-file-input", multiple, accept, disabled, ref: inputRef }), clearable && /* @__PURE__ */ react_default.createElement(Button, { size: Button.Sizes.ICON, look: Button.Looks.BLANK, onClick: clear, className: "bd-file-input-clear" }, /* @__PURE__ */ react_default.createElement(X, { size: "24px" })));
}
...
var Position = ({ value: initialValue, onChange, disabled }) => {
  ...
  return /* @__PURE__ */ react_default.createElement("div", { className: "position-wrapper" }, /* @__PURE__ */ react_default.createElement("div", { className: `bd-container${isDisabled ? "-disabled" : ""}` }, positions.map((position) => /* @__PURE__ */ react_default.createElement(
    "button",
    {
      key: position,
  ...
  ))), /* @__PURE__ */ react_default.createElement("div", { className: "bd-position-info" }, value ? /* @__PURE__ */ react_default.createElement(react_default.Fragment, null, /* @__PURE__ */ react_default.createElement(Text, null, "Selected Position:"), /* @__PURE__ */ react_default.createElement(Text, null, value.replace(/-/g, " ").toUpperCase())) : /* @__PURE__ */ react_default.createElement(Text, null, "Click a box to select position")));
};
...
init_i18n();
init_modals();
var UserSettings = getByKeys(["openUserSettings", "openUserSettingsFromParsedUrl"], { firstId: 840065, cacheId: "core-settings-usersettings" });
...
var settings_default3 = new class SettingsRenderer {
  ...
  getLayoutBuilder() {
    ...
    const layoutModuleRaw = discordmodules_default.Layout;
    const out = {};
  ...
  async patchModalSettings() {
    ...
    const section = layoutBuilder.section("In-Accord", {
      buildLayout: () => {
        const layouts = [];
        const insert = (key, item) => {
          ...
          const sidebar = layoutBuilder.sidebarItem(key, {
            ...
            useTitle: item.title,
            icon: item.icon,
            getLegacySearchKey: () => `In-Accord_${key}`,
            usePredicate: () => true
          });
          ...
          function PanelHeader() {
            ...
            return /* @__PURE__ */ react_default.createElement(react_default.Fragment, null, /* @__PURE__ */ react_default.createElement(
              "div",
              {
                ...
                ref: (v) => {
                  const flex = v?.closest("div[data-wrap][data-full-width] > nav")?.parentElement;
                  if (flex) {
              ...
              /* @__PURE__ */ react_default.createElement("div", { className: "bd-settings-page-title-children" }, ref.current.children),
              node
            ));
          }
          return {
      ...
      useTitle: () => Object.assign(/* @__PURE__ */ react_default.createElement(LayerSettingTitle, null), { toString: () => "In-Accord" })
    });
    Patcher.after("SettingsManager", rootLayout, "buildLayout", (that, args, res) => {
      let index = res.findIndex((layout) => layout.key === "activity_section") + 1;
  ...
  openSettingsPage(key) {
    UserSettings?.openUserSettings?.(`In-Accord_${key === "customcss" ? "customcss_tab" : key}_panel`, {
      section: key
    });
  }
  forceUpdate() {
    const viewClass = discordmodules_default.ViewClasses?.standardSidebarView.split(" ")[0];
...
init_editor3();
init_lucide_react();
var { useState: useState23, useCallback: useCallback28, useEffect: useEffect12, forwardRef: forwardRef4, useImperativeHandle: useImperativeHandle4, useRef: useRef11 } = react_default;
var csseditor_default = forwardRef4(function CssEditor({ css: css2, openNative, update, save, onChange: notifyParent, readOnly = false, id = "bd-customcss-editor", openDetached = false }, ref) {
...
var UserSettings2 = getByKeys(["updateAccount"], { firstId: 252452, cacheId: "core-customcss-usersettings" });
var customcss_default = new class CustomCSS extends BuiltinModule {
  ...
  get file() {
    return import_path7.default.resolve(config_default.get("channelPath"), "custom.css");
  }
  savedCss;
  insertedCss;
  isDetached;
  ...
  watchContent() {
    ...
    if (!import_fs7.default.existsSync(this.file)) {
      try {
        import_fs7.default.mkdirSync(import_path7.default.dirname(this.file), { recursive: true });
        import_fs7.default.writeFileSync(this.file, "");
      } catch (err) {
    ...
    this.watcher = import_fs7.default.watch(this.file, { persistent: false }, async (eventType, filename) => {
      if (!eventType || !filename) return;
      await new Promise((r2) => setTimeout(r2, 50));
      try {
        import_fs7.default.statSync(this.file);
      } catch (err) {
        if (err.code !== "ENOENT") return;
        delete timeCache[filename];
        this.saveCSS("");
      }
      const stats = import_fs7.default.statSync(this.file);
      if (!stats || !stats.mtimeMs) return;
      if (typeof stats.mtimeMs !== "number") return;
  ...
  loadCSS() {
    try {
      this.savedCss = import_fs7.default.readFileSync(this.file).toString();
    } catch {
      this.savedCss = "";
    }
  }
  ...
  saveCSS(newCss) {
    ...
    import_fs7.default.writeFileSync(this.file, this.savedCss);
  }
  open() {
    if (this.isDetached) return;
    if (this.nativeOpen) return this.openNative();
...
// src/In-Accord/builtins/general/contextmenu.tsx
init_i18n();
init_settings3();
...
var ModulesBundle = getByKeys(["MenuItem", "Menu"], { cacheId: "core-contextmenu-ModulesBundle" });
var MenuComponents = {
...
var MenuPatcher = class _MenuPatcher {
  ...
  static handleRender(Component2) {
    ...
    nodePatcher.patch(fNode, (props, node, instance) => {
      if (react_default.isValidElement(node)) {
        if (node.props.navId) {
  ...
  static patchRecursive(target, iteration = 0) {
    ...
    nodePatcher.patch(target, (props, res, instance) => {
      if (react_default.isValidElement(res)) {
...
var BDContextMenu = new class BDContextMenu2 extends BuiltinModule {
  get name() {
  ...
  async enabled() {
    this.patch = ContextMenu2.patch("user-settings-cog", (retVal) => {
...
function useCollectionMenu() {
  const collections = useStateFromStores(settings_default2, () => {
    const c = [];
    for (const collection of settings_default2.collections) {
      c.push({
        id: collection.id,
        ...
        settings: collection.settings.map((category) => ({
          ...
          settings: category.settings.filter((s) => s.type === "switch" && !s.hidden && s.id !== BDContextMenu.id).map((setting) => ({
            ...
            checked: settings_default2.get(collection.id, category.id, setting.id),
  ...
  return /* @__PURE__ */ react_default.createElement(react_default.Fragment, null, collections.map((collection) => /* @__PURE__ */ react_default.createElement(
    ContextMenu2.Item,
    {
      label: collection.name,
      id: collection.id,
    ...
    collection.settings.map((category) => /* @__PURE__ */ react_default.createElement(
      ContextMenu2.Item,
      {
        label: category.name,
        id: category.id,
      ...
      category.settings.map((setting) => /* @__PURE__ */ react_default.createElement(ContextMenu2.CheckboxItem, { ...setting, key: `bd.${collection.id}.${category.id}.${setting.id}` }))
    ))
  )));
}
function useAddonMenu(type, label, manager) {
  const addons = useStateFromStores(manager, () => manager.addonList.map((a) => a.name || a.getName?.()).sort((a, b) => a.toLowerCase().localeCompare(b.toLowerCase())).map((name) => [name, manager.getAddon(name), manager.isEnabled(name)]), [], true);
  const addonStoreIsEnabled = useStateFromStores(settings_default2, () => settings_default2.get("settings", "store", "bdAddonStore"), []);
  const toggles = useMemo(() => addons.map(([name, addon, enabled]) => /* @__PURE__ */ react_default.createElement(
    ContextMenu2.CheckboxItem,
    {
      label: name,
      id: name,
      checked: enabled,
      ...
      action: (e) => {
        ...
        if (!manager.isEnabled(name)) {
          toasts_default.warning(t("Addons.isDisabled", { name }));
          return;
        }
        const hasSettings = addon.instance && typeof addon.instance.getSettingsPanel === "function";
        const getSettings = hasSettings && addon.instance.getSettingsPanel.bind(addon.instance);
        if (hasSettings) {
          ...
          toasts_default.warning(t("Addons.noSettings", { name }));
        }
      }
    }
  )), [addons, manager, type]);
  return /* @__PURE__ */ react_default.createElement(ContextMenu2.Item, { label, id: type, action: () => openCategory(manager.prefix + "s") }, /* @__PURE__ */ react_default.createElement(ContextMenu2.Group, { key: `bd.${type}.installed` }, toggles), addonStoreIsEnabled && /* @__PURE__ */ react_default.createElement(ContextMenu2.Group, { key: `bd.${type}.store` }, /* @__PURE__ */ react_default.createElement(
    ContextMenu2.Item,
    {
...
function useCustomCSSMenuItem() {
  const isEnabled = useStateFromStores(settings_default2, () => settings_default2.get("settings", "customcss", "customcss"), []);
...
function useBDContextMenu() {
  ...
  const plugins = useAddonMenu("plugin", t("Panels.plugins"), pluginmanager_default);
  const themes = useAddonMenu("theme", t("Panels.themes"), thememanager_default);
  return /* @__PURE__ */ react_default.createElement(ContextMenu2.Group, null, /* @__PURE__ */ react_default.createElement(ContextMenu2.Item, { label: "In-Accord", id: "In-Accord" }, collections, /* @__PURE__ */ react_default.createElement(
    ContextMenu2.Item,
    {
  ...
  ), customCSS, plugins, themes));
}
var contextmenu_default2 = BDContextMenu;

// src/In-Accord/builtins/general/themeattributes.tsx
init_webpack2();
init_utils();
init_react();
var MessageGroupingContext = react_default.createContext({
  first: false,
  last: false
});
var themeattributes_default = new class ThemeAttributes extends BuiltinModule {
  ...
  async patchMessage() {
    ...
    this.after(MessageComponent, "type", (_, [props], returnValue) => {
      const { first, last } = react_default.useContext(MessageGroupingContext);
  ...
  async patchMessageHook() {
    ...
    this.after(messageHook, "A", (_, __, res) => {
      ...
      for (let i = 0; i < channelStreamMarkup.length; i++) {
        ...
        res.channelStreamMarkup[index] = /* @__PURE__ */ react_default.createElement(MessageGroupingContext, { value: { last, first } }, res.channelStreamMarkup[index]);
      }
    });
  }
...
var addons_default = (type) => {
  ...
  return {
    ...
    execute: async (data, { channel }) => {
      ...
      if (action === "share") {
        discordmodules_default.MessageUtils.sendMessage(channel.id, { content: `<In-Accord://store/${encodeURIComponent(addon.name)}>` }, void 0, {});
      }
    }
  };
};
...
\`\`\``;
    ...
    return { content: "Unable to attach your debug info as a file. Please report this issue to In-Accord's [GitHub](https://github.com/In-Accord/In-Accord) if no one else has already done so!" };
  }
};
...
var restart_default = {
  id: "restart",
  name: "restart",
  description: "Restart Discord with or without In-Accord",
  options: [
    {
      type: OptionTypes.BOOLEAN,
      name: "vanilla",
      description: "Should Discord be relaunched without In-Accord?",
      required: true
    }
  ],
  execute: async (data) => {
...
var support_default = {
  id: "support",
  name: "support",
  description: "Get help and support for In-Accord",
  options: [],
  execute: async () => {
...
var customcss_default2 = {
  ...
  execute: async (data, { channel }) => {
    ...
    if (action === "share") {
      ...
      if (discordmodules_default.promptToUpload) return setTimeout(() => discordmodules_default.promptToUpload?.([file], channel, 0), 1);
      return { content: "Unable to attach your Custom CSS as a file. Please report this issue to In-Accord's [GitHub](https://github.com/In-Accord/In-Accord) if no one else has already done so!" };
    }
  }
};
...
init_react();
var { useState: useState24, useEffect: useEffect13 } = react_default;
function AddonEmbed({ id, original }) {
  ...
  if (!addon) {
    ...
    return /* @__PURE__ */ react_default.createElement("div", { className: "bd-addon-store-card-embed bd-addon-store-card-loading" }, /* @__PURE__ */ react_default.createElement(spinner_default, { type: spinner_default.Type.SPINNING_CIRCLE }));
  }
  return /* @__PURE__ */ react_default.createElement(
    TagContext.Provider,
    {
...
var MAX_EMBEDS = 10;
var PROTOCOL_REGEX = /^<In-Accord:\/\/(?:(?:theme|plugin|addon)s?|store)\/([^/\s]+)\/?>/i;
var APP_PROTOCOL_REGEX = /^In-Accord:\/\/(?:(?:theme|plugin|addon)s?|store)\/([^/]+)\/?$/i;
var ADDON_REGEX = new RegExp([
  PROTOCOL_REGEX.source.slice(1),
  /https?:\/\/In-Accord\.app\/(?:theme|plugin)(?:\/([^/\s]+)\/?|\?id=(\d+))/.source
].join("|"), "gi");
...
var addonstore_default2 = new class AddonStoreBuiltin extends BuiltinModule {
  ...
  async enabled() {
    ...
    this.extractDiscordProtocolList().push("In-Accord:");
  }
    ...
    this.before(module2, key, (_, args) => {
      if (args[0].href) {
        ...
        if (url.host === Web.hostname && url.pathname.toLowerCase() === "/download" && !isNaN(id)) {
          ...
          args[0].href = `In-Accord://store/${id}`;
  ...
  extractDiscordProtocolList() {
    ...
    let protocols = [];
    const link = discordmodules_default.LinkParser;
    ...
    link.parse(["", "link", "In-Accord://foo/bar"]);
  ...
  async disabled() {
    ...
    const index = list.indexOf("In-Accord:");
    if (index !== -1) {
      list.splice(index, 1);
    }
    this.unpatchAll();
...
var NotificationUI = class _NotificationUI {
  ...
  constructor() {
    ...
    _NotificationUI.container = container;
    ReactDOM2.createRoot(container).render(/* @__PURE__ */ react_default.createElement(PersistentNotificationContainer, null));
  }
  show(notif) {
...
var PersistentNotificationContainer = () => {
...
var NotificationItem = ({ notification }) => {
  ...
  return /* @__PURE__ */ react_default.createElement(
    ...
    /* @__PURE__ */ react_default.createElement("div", { className: "bd-notification-content" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-notification-header" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-notification-icon" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-notification-icon" }, notification.icon ? /* @__PURE__ */ react_default.createElement(ErrorBoundary, null, /* @__PURE__ */ react_default.createElement(notification.icon, null)) : /* @__PURE__ */ react_default.createElement(Icon2, { type }))), title && /* @__PURE__ */ react_default.createElement("div", { className: "bd-notification-title" }, title)), content && /* @__PURE__ */ react_default.createElement("div", { className: "bd-notification-body" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-notification-content-text" }, content && /* @__PURE__ */ react_default.createElement("div", { className: "bd-notification-body" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-notification-content-text" }, typeof content === "string" ? /* @__PURE__ */ react_default.createElement(Markdown, null, content) : /* @__PURE__ */ react_default.createElement(ErrorBoundary, null, content)))))),
    actions.length > 0 && /* @__PURE__ */ react_default.createElement("div", { className: "bd-notification-footer" }, actions.map((action, index) => {
      const color = Colors2[action?.color?.toUpperCase()] ? `bd-button-color-${action?.color}` : Button.Colors.PRIMARY;
...
var TEST_PLUGIN_REGEX = /In-Accord:\/\/(plugins)\/(.*?).(\w+).js/;
...
var ErrorDetails = ({ componentStack, pluginInfo, stack, instance }) => {
...
`
  ...
  const openDiscordSupport = async () => {
    if (pluginInfo?.invite) {
      ...
      if (recoverySuccessful) {
        ...
        toasts_default.show(t("Toasts.recoveryFailed"));
      }
    }
  };
  return /* @__PURE__ */ react_default.createElement("div", { className: "bd-error-container" }, /* @__PURE__ */ react_default.createElement("div", { className: "bd-error-toggle-wrapper" }, /* @__PURE__ */ react_default.createElement(
    Button,
    {
  ...
  ), /* @__PURE__ */ react_default.createElement("div", { className: "bd-error-actions" }, pluginInfo?.githubUrl && /* @__PURE__ */ react_default.createElement(
    Button,
    {
    ...
    /* @__PURE__ */ react_default.createElement("div", { ref: contentRef, className: "bd-error-content" }, componentStack)
  ));
};
var recovery_default = new class Recovery extends BuiltinModule {
  ...
  patchErrorBoundry() {
    ...
    this.after(mod?.prototype, "render", (instance, args, retValue) => {
      ...
      const parsedError = errorStack ? discordmodules_default.SimpleMarkdownWrapper.parse(`\`\`\`${errorStack.error?.stack}
...
${errorStack.info?.componentStack}\`\`\``) : null;
      ...
      buttons.className = clsx_default(buttons.className, "bd-recovery-buttons");
      ...
      if (parsedError) {
        retValue.props.action = [
          retValue?.props?.action,
          /* @__PURE__ */ react_default.createElement(ErrorDetails, { componentStack: parsedError, stack: errorStack?.error?.stack, pluginInfo, instance })
        ];
      }
    });
  }
...
var debuglogs_default = new class DebugLogs extends BuiltinModule {
  ...
  stream;
  async enabled() {
    this.logFile = import_path8.default.join(config_default.get("channelPath"), "debug.log");
    await this.checkFilesize();
    this.stream = import_fs8.default.createWriteStream(this.logFile, { flags: "a" });
    this.stream.write(`
...
${arg.stack}`);
  ...
  async checkFilesize() {
    try {
      if (!this.logFile || !import_fs8.default.existsSync(this.logFile)) return;
      const stats = import_fs8.default.statSync(this.logFile);
      ...
      return new Promise((resolve) => Modals.showConfirmationModal(t("Modals.additionalInfo"), t("Modals.debuglog"), {
        ...
        cancelText: t("Modals.cancel"),
        danger: true,
        onConfirm: () => import_fs8.default.rmSync(this.logFile),
        onClose: resolve
      }));
    } catch (e) {
...
init_button();
init_lucide_react();
var { useState: useState25, useCallback: useCallback29, useEffect: useEffect14 } = react_default;
function makeButton3(tooltip, children, action, options = {}) {
  ...
  return /* @__PURE__ */ react_default.createElement(discordmodules_default.Tooltip, { color: "primary", position: "top", text: tooltip }, (props) => /* @__PURE__ */ react_default.createElement(Button, { ...props, "aria-label": tooltip, className: `bd-update-button ${className}`, size, look, color, onClick }, children));
}
function CoreUpdaterPanel({ hasUpdate, remoteVersion, update }) {
  return /* @__PURE__ */ react_default.createElement(Drawer, { name: "In-Accord", collapsible: true }, /* @__PURE__ */ react_default.createElement(SettingItem, { name: `Core v${config_default.get("version")}`, note: hasUpdate ? t("Updater.versionAvailable", { version: remoteVersion }) : t("Updater.noUpdatesAvailable"), inline: true, id: "core-updater" }, !hasUpdate && /* @__PURE__ */ react_default.createElement("div", { className: "bd-filled-checkmark" }, /* @__PURE__ */ react_default.createElement(Check, { size: "18px" })), hasUpdate && makeButton3(t("Updater.updateButton"), /* @__PURE__ */ react_default.createElement(ArrowDownToLine, null), update, { className: "no-animation" })));
}
function NoUpdates({ type }) {
  return /* @__PURE__ */ react_default.createElement("div", { className: "bd-empty-updates" }, /* @__PURE__ */ react_default.createElement(Check, { size: "48px" }), t("Updater.upToDateBlankslate", { context: type.slice(0, -1) }));
}
function AddonUpdaterPanel({ pending: filenames, type, updater, update, updateAll }) {
  return /* @__PURE__ */ react_default.createElement(
    Drawer,
    {
      name: t(`Panels.${type}`),
    ...
    filenames.map((f) => {
      ...
      if (!info) return null;
      return /* @__PURE__ */ react_default.createElement(SettingItem, { key: addon.filename, name: `${addon.name} v${addon.version}`, note: t("Updater.versionAvailable", { version: info.version }), inline: true, id: addon.name }, makeButton3(t("Updater.updateButton"), /* @__PURE__ */ react_default.createElement(RotateCw, null), () => update(type, f)));
    })
  );
}
function UpdaterPanel({ coreUpdater, pluginUpdater, themeUpdater }) {
  const [hasCoreUpdate, setCoreUpdate] = useState25(coreUpdater.hasUpdate);
  const [updates, setUpdates] = useState25({ plugins: pluginUpdater.pending.slice(0), themes: themeUpdater.pending.slice(0) });
  ...
  useEffect14(() => {
    emitter_default.on(`plugin-loaded`, update);
    emitter_default.on(`plugin-unloaded`, update);
    emitter_default.on(`theme-loaded`, update);
    emitter_default.on(`theme-unloaded`, update);
    return () => {
      emitter_default.off(`plugin-loaded`, update);
      emitter_default.off(`plugin-unloaded`, update);
      emitter_default.off(`theme-loaded`, update);
      emitter_default.off(`theme-unloaded`, update);
    };
  }, [update]);
  ...
  return [
    set(
      /* @__PURE__ */ react_default.createElement(SettingsTitle, { text: t("Panels.updates") }, makeButton3(t("Updater.checkForUpdates"), /* @__PURE__ */ react_default.createElement(RefreshCw, null), checkForUpdates, { className: "bd-update-check", stopAnimation: true }))
    ),
...
var CoreUpdater = class {
  ...
  static async checkForStable(ignoreVersion = false) {
    const resp = await fetch(`https://api.github.com/repos/In-Accord/In-Accord/releases/latest`, {
      method: "GET",
      headers: {
        "Accept": "application/json",
        "Content-Type": "application/json",
        "User-Agent": "In-Accord Updater"
      }
    });
  ...
  static async checkForCanary(ignoreVersion = false) {
    const resp = await fetch(`https://api.github.com/repos/In-Accord/In-Accord/releases`, {
      method: "GET",
      headers: {
        "Accept": "application/json",
        "Content-Type": "application/json",
    ...
    const asset = data?.assets.find((a) => a.name === "In-Accord.asar");
    if (!data || !asset) {
  ...
  static async update() {
    try {
      const asar = this.apiData.assets.find((a) => a.name === "In-Accord.asar");
      if (!asar) return;
      ...
      const asarPath = import_path9.default.join(config_default.get("dataPath"), "In-Accord.asar");
...
var AddonUpdater = class {
  ...
  checkForUpdate(filename, currentVersion) {
    ...
    const info = this.cache[import_path9.default.basename(filename)];
    if (!info) return;
  ...
  async updateAddon(filename) {
    ...
    (0, import_request3.default)({
      ...
      if (error || response.statusCode !== 200) {
        ...
        toasts_default.error(t("Updater.addonUpdateFailed", { name: info.name, version: info.version }));
        return;
      }
      const file = import_path9.default.join(import_path9.default.resolve(this.manager.addonFolder), filename);
      import_fs9.default.writeFile(file, body.toString(), () => {
...
function Toast({ content, type, icon, style }) {
  return /* @__PURE__ */ react_default.createElement(ReactSpring.animated.div, { className: clsx_default("bd-toast", `toast-${type}`), style }, icon && /* @__PURE__ */ react_default.createElement(ToastIcon, { type }), /* @__PURE__ */ react_default.createElement("span", null, content));
}
...
var Toasts2 = class _Toasts {
  ...
  static initialize() {
    ...
    DOMManager.bdBody.appendChild(container);
    _Toasts.root = reactdom_default.createRoot(container);
    _Toasts.root.render(react_default.createElement(ToastContainer));
  }
};
...
var InstallCSS = class {
  ...
  static initialize() {
    ...
    const codeBlockStyles = getByKeys(["codeActions"], { firstId: 206314, cacheId: "core-mdinstallcss-codeBlockStyles" });
...
var core_default = new class Core {
  ...
  trustInAccordProtocol() {
    Patcher.after("In-AccordProtocol", getStore("MaskedLinkStore"), "isTrustedProtocol", (_, [url], ret) => ret || url.startsWith("In-Accord://"));
  }
  async startup() {
    if (this.hasStarted) return;
    this.hasStarted = true;
    ipc_default.getSystemAccentColor().then((value) => DOMManager.injectStyle("bd-os-values", `:root {--os-accent-color: #${value};}`));
    this.trustInAccordProtocol();
    Logger.log("Startup", "Injecting BD Styles");
    DOMManager.injectStyle("bd-stylesheet", styles_default.toString());
...
var Patcher2 = class {
  ...
  getPatchesByCaller(caller) {
    ...
    if (typeof caller !== "string") return Logger.err("Ia-Api.Patcher", "Parameter 0 of getPatchesByCaller must be a string representing the caller");
  ...
  unpatchAll(caller) {
    if (this.#callerName) caller = this.#callerName;
    if (typeof caller !== "string") return Logger.err("Ia-Api.Patcher", "Parameter 0 of unpatchAll must be a string representing the caller");
...
var Notices = class {
  ...
  static get baseClass() {
    return this.__baseClass ??= discordmodules_default.NoticesBaseClasses?.base;
  }
  static get errorPageClass() {
    return this.__errorPageClass ??= discordmodules_default.NoticesPageClasses?.errorPage;
  }
  ...
  static show(content, options = {}) {
    ...
    const noticeElement = this.createElement("div", {
      className: clsx_default("bd-notice", type && `bd-notice-${type}`)
...
var UI = {
   ...
   * `Ia-Api.Components` section for details. Shown below are ones common to all setting types.
...
var Utils = {
  ...
  */
   ...
   */
  getNestedValue(object, path11) {
    return getNestedProp(object, path11);
  },
  /**
...
var Webpack = {
  ...
  getWithKey(filter, options = {}) {
    if ("first" in options) return Logger.error("Ia-Api.Webpack~getWithKey", "Unsupported option first.");
    if ("defaultExport" in options && typeof options.defaultExport !== "boolean") return Logger.error("Ia-Api.Webpack~getWithKey", "Invalid type for options.defaultExport", options.defaultExport, "Expected: boolean");
    if ("searchExports" in options && typeof options.searchExports !== "boolean") return Logger.error("Ia-Api.Webpack~getWithKey", "Invalid type for options.searchExports", options.searchExports, "Expected: boolean");
    if ("raw" in options && typeof options.raw !== "boolean") return Logger.error("Ia-Api.Webpack~getWithKey", "Invalid type for options.raw", options.raw, "Expected: boolean");
    return getWithKey(filter, options);
  },
  getModule(filter, options = {}) {
    if ("first" in options && typeof options.first !== "boolean") return Logger.error("Ia-Api.Webpack~get", "Invalid type for options.first", options.first, "Expected: boolean");
    if ("defaultExport" in options && typeof options.defaultExport !== "boolean") return Logger.error("Ia-Api.Webpack~getModule", "Invalid type for options.defaultExport", options.defaultExport, "Expected: boolean");
    if ("searchExports" in options && typeof options.searchExports !== "boolean") return Logger.error("Ia-Api.Webpack~getModule", "Invalid type for options.searchExports", options.searchExports, "Expected: boolean");
    if ("raw" in options && typeof options.raw !== "boolean") return Logger.error("Ia-Api.Webpack~getModule", "Invalid type for options.raw", options.raw, "Expected: boolean");
    if (options.first === false) return getAllModules(filter, options);
    return getModule(filter, options);
  },
  getModules(filter, options = {}) {
    if ("defaultExport" in options && typeof options.defaultExport !== "boolean") return Logger.error("Ia-Api.Webpack~getModules", "Invalid type for options.defaultExport", options.defaultExport, "Expected: boolean");
    if ("searchExports" in options && typeof options.searchExports !== "boolean") return Logger.error("Ia-Api.Webpack~getModules", "Invalid type for options.searchExports", options.searchExports, "Expected: boolean");
    if ("raw" in options && typeof options.raw !== "boolean") return Logger.error("Ia-Api.Webpack~getModules", "Invalid type for options.raw", options.raw, "Expected: boolean");
  ...
  waitForModule(filter, options = {}) {
    if ("defaultExport" in options && typeof options.defaultExport !== "boolean") return Logger.error("Ia-Api.Webpack~waitForModule", "Invalid type for options.defaultExport", options.defaultExport, "Expected: boolean");
    if ("signal" in options && !(options.signal instanceof AbortSignal)) return Logger.error("Ia-Api.Webpack~waitForModule", "Invalid type for options.signal", options.signal, "AbortSignal expected.");
    if ("searchExports" in options && typeof options.searchExports !== "boolean") return Logger.error("Ia-Api.Webpack~waitForModule", "Invalid type for options.searchExports", options.searchExports, "Expected: boolean");
    if ("raw" in options && typeof options.raw !== "boolean") return Logger.error("Ia-Api.Webpack~waitForModule", "Invalid type for options.raw", options.raw, "Expected: boolean");
  ...
  getMangled(filter, mangled, options = {}) {
    ...
    if (typeof defaultExport !== "boolean") return Logger.error("Ia-Api.Webpack~getMangled", "Invalid type for options.defaultExport", defaultExport, "Expected: boolean");
    if (typeof searchExports !== "boolean") return Logger.error("Ia-Api.Webpack~getMangled", "Invalid type for options.searchExports", searchExports, "Expected: boolean");
    if (typeof raw !== "boolean") return Logger.error("Ia-Api.Webpack~getMangled", "Invalid type for options.raw", raw, "Expected: boolean");
...
function dryReadableStream(stream) {
...
function hydrateReadableStream(stream) {
...
function dryAbortSignal(signal) {
  return {
...
var HydratingResponse = class extends Response {
  #dried;
  constructor(dried) {
...
async function fetch2(input, init) {
  ...
  if (input instanceof Request) {
    ...
    request3 = new Request(input.href, init);
  } else {
    request3 = new Request(input, init);
  }
  const driedResponse = await remote_default.nativeFetch({
    url: request3.url,
    body: request3.body ? dryReadableStream(request3.body) : null,
    headers: Object.fromEntries(request3.headers),
    keepalive: request3.keepalive,
    method: methods2.has(request3.method) ? request3.method : "GET",
    redirect: request3.redirect,
    signal: request3.signal ? dryAbortSignal(request3.signal) : null,
...
var ReactDOM3 = reactdom_default;
...
var IaApi = class _IaApi {
  ...
  constructor(pluginName) {
    ...
    if (typeof pluginName !== "string") {
      Logger.error("Ia-Api", "Plugin name not a string, returning generic API!");
      return _IaApi;
    }
...
secure_default();
Object.defineProperty(window, "Ia-Api", {
  value: IaApi,
  writable: false,
  configurable: false
});
