...
var amdLoader = window.require;
var title = window.Editor.filename;
...
var baseUrl = `https://cdnjs.cloudflare.com/ajax/libs/monaco-editor/${"0.55.1"}/min`;
...
var { options, liveUpdate: defaultLiveUpdate, discordTheme } = window.Editor.settings.get();
...
amdLoader(["vs/editor/editor.main"], (monaco) => {
  ...
  if (window.Editor.type !== "custom-css") {
    liveUpdateNode.parentElement.remove();
  } else {
