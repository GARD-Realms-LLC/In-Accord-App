...
// Do not auto-install a global `require` into the page.
// Canary runs with strict context isolation/no Node in the page world.
// The app is built to not depend on `require` for startup.
