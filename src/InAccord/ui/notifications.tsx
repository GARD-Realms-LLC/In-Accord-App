...
class NotificationUI {
    ...
    constructor() {
        ...
        if (typeof anyDOM?.createRoot === "function") {
            anyDOM.createRoot(contianer).render(<PersistentNotificationContianer />);
        }
        else if (typeof anyDOM?.render === "function") {
            anyDOM.render(<PersistentNotificationContianer />, contianer);
        }
    }
