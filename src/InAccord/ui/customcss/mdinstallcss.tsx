...
class InstallCSS {
    ...
    static initialize() {
        const md = getModule((m) => m?.defaultRules && m?.parse) as SimpleMarkdown | undefined;
        const patch = md?.defaultRules?.codeBlock as Required<Rule> | undefined;

        // Discord frequently reshapes its markdown parser exports.
        // This feature is optional; if we can't find the parser, do nothing.
