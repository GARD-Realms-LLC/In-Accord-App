...
const runtimeProcess = (globalThis as any).process as {platform?: string; env?: Record<string, string | undefined>;} | undefined;
const runtimePlatform = runtimeProcess?.platform ?? "win32";
