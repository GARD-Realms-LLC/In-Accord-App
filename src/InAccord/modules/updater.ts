import fileSystem from "@polyfill/fs";
...
export class CoreUpdater {
    ...
    static async update() {
        try {
            ...
            fileSystem.writeFileSync(asarPath, buff as any);
...
export class AddonUpdater {
    ...
    async updateAddon(filename: string) {
        ...
        try {
            ...
            Logger.stacktrace("AddonUpdater", `Fialed to download body for ${info.id}:`, error as Error);
