import path from "@polyfill/path";
...
export default new class PluginManager extends AddonManager {
    ...
    requireAddon(filename: string) {
        ...
        try {
            ...
            // Avoid Node's `vm` module in Discord/Electron renderer processes (Canary can crash).
            // new Function will throw a SyntaxError on invalid code, which we catch below.
